        ...
        \subsection*{Linear Algebra}
            ...
            \subsubsection*{Matrices}
                ...
                \begin{center}
                    ...
                    \end{bmatrix}$
                \end{center}
                A $\mathbb{R}^{1 \times n}$ matrix is refered to as a \textbf{row (vector)}, and a $\mathbb{R}^{m \times 1}$ matrix is referred to as a \textbf{column (vector)}, with componentwise addition, we are able to say $(\mathbb{R}^{m \times n}, +)$ is a group.
                \medskip
                ...
                A multiplication by scalar $\lambda \in \mathbb{R}$, means that for $\mat{A} \in \mathbb{R}^{m \times n}$, and $\mat{B} = \lambda \mat{A}$, it follows thatt $b_{i, j} = \lambda a_{i, j}$. This operation is distributive, and also associative.
