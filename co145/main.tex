    ...
    \section*{CO145 - Mathematical Methods}
        ...
        \subsection*{Linear Algebra}
            ...
            \subsubsection*{Minus-1 Trick}
                ...
                \end{bmatrix}$, to create a square matrix;
                \begin{center}
                    $\mat{A} = \begin{bmatrix}
                        \textcolor{violet}{1} & 3 & 0 & 0 & 3 \\
                        0 & 0 & \textcolor{violet}{1} & 0 & 3 \\
                    ...
                    \end{bmatrix}$
                \end{center}
                By reading the columns containing the new \textcolor{red}{-1}s, we can get all solutions for $\mat{A}\vec{x} = \vec{0}$
\end{document}
