    ...
    \section*{CO343 - Operations Research \hfill (60016)}
        ...
        \subsection*{Lecture 9}
            ...
            \subsubsection*{Strong Duality}
                For convex problems (specifically linear programs in our case), under a few assumptions, the optimal values for the dual and primal are equal.
                \medskip
                ...
                \begin{center}
                    ...
                    \begin{minipage}[t]{0.3\textwidth}
                        ...
                        \begin{mini*}|l|
                            {}{\vec{b}^\top\vec{y}}
                            {}{}
                            \addConstraint{\mat{A}^\top\vec{y}}{\geq \vec{c}}
        ...
        \subsection*{Lecture 10}
            \subsubsection*{Indirect Way}
                ...
                \begin{maxi*}|l|
                    ...
                    \addConstraint{2x_1 - x_2}{\geq 3}
                    \addConstraint{x_1 - x_2}{\leq 1}
                    \addConstraint{x_1}{\geq 0}
                    \addConstraint{x_2}{\in \mathbb{R}}
                \end{maxi*}
                The algorithm is as follows;
                \begin{enumerate}[1.]
                    \itemsep0em
                    \item bring LP to either (P) or (D)
                        \begin{itemize}
                            \itemsep0em
                            \item replace any unbounded variables (not positive) $x_i \in \mathbb{R}$ with $(x^+_i - x^-_i)$, where $x^+_i, x^-_i \geq 0$
                                \begin{maxi*}|l|
                                    {}{2x_1 + \violet{x^+_2 - x^-_2}}
                                    {}{}
                                    \addConstraint{x_1 + \violet{x^+_2 - x^-_2}}{= 2}
                                    \addConstraint{2x_1 - \violet{x^+_2 + x^-_2}}{\geq 3}
                                    \addConstraint{x_1 - \violet{x^+_2 + x^-_2}}{\leq 1}
                                    \addConstraint{x_1, \violet{x^+_2}, \violet{x^-_2}}{\geq 0}
                                \end{maxi*}
                            \item replace any equality constraints with two inequality constraints
                                \begin{maxi*}|l|
                                    {}{2x_1 + x^+_2 - x^-_2}
                                    {}{}
                                    \addConstraint{\violet{x_1 + x^+_2 - x^-_2}}{\ \violet{\leq 2}}
                                    \addConstraint{\violet{x_1 + x^+_2 - x^-_2}}{\ \violet{\geq 2}}
                                    \addConstraint{2x_1 - x^+_2 + x^-_2}{\geq 3}
                                    \addConstraint{x_1 - x^+_2 + x^-_2}{\leq 1}
                                    \addConstraint{x_1, x^+_2, x^-_2}{\geq 0}
                                \end{maxi*}
                            \item change any constraint directions with negation if necessary
                                \begin{maxi*}|l|
                                    {}{2x_1 + x^+_2 - x^-_2}
                                    {}{}
                                    \addConstraint{x_1 + x^+_2 - x^-_2}{\leq 2}
                                    \addConstraint{\violet{-x_1 - x^+_2 + x^-_2}}{\ \violet{\leq -2}}
                                    \addConstraint{\violet{-2x_1 + x^+_2 - x^-_2}}{\ \violet{\leq -3}}
                                    \addConstraint{x_1 - x^+_2 + x^-_2}{\leq 1}
                                    \addConstraint{x_1, x^+_2, x^-_2}{\geq 0}
                                \end{maxi*}
                        ...
                        \begin{itemize}
                            \item if LP is now in form (P), dual is (D)
                                ...
                                \begin{mini*}|l|
                                    {}{2y_1 - 2y_2 - 3y_3 + y_4}
                                    {}{}
                                    \addConstraint{y_1 - y_2 - 2y_3 + y_4}{\geq 2}
                                    \addConstraint{y_1 - y_2 + y_3 - y_4}{\geq 1}
                                    \addConstraint{-y_1 + y_2 - y_3 + y_4}{\geq -1}
                                    \addConstraint{y_1, y_2, y_3, y_4}{\geq 0}
                                \end{mini*}
                    ...
                    \item simplify dual problem (optional)
                        ...
                        \begin{mini*}|l|
                            {}{2y^\prime_1 - 3y_3 + y_4}
                            {}{}
                            \addConstraint{y^\prime_1 - 2y_3 + y_4}{\geq 2}
                            \addConstraint{y^\prime_1 + y_3 - y_4}{= 1}
                            \addConstraint{y_3, y_4}{\geq 0}
                            \addConstraint{y^\prime_1}{\in \mathbb{R}}
                        \end{mini*}
                \end{enumerate}
            ...
            \subsubsection*{Sensitivity Analysis}
                ...
                \begin{maxi*}|l|
                    {}{y = x_1 + x_2}
                    {}{}
                    \addConstraint{2x_1 + x_2}{\leq p_1}
                    \addConstraint{x_1 + 3x_2}{\leq 18}
                    \addConstraint{x_1}{\leq 4}
                    \addConstraint{x_1, x_2}{\geq 0}
                \end{maxi*}
                In standard form;
                \begin{mini*}|l|
                    {}{z = -x_1 - x_2}
                    {}{-}
                    \addConstraint{2x_1 + x_2 + x_3}{= p_1}
                    \addConstraint{x_1 + 3x_2 + x_4}{= 18}
                    \addConstraint{x_1 + x_5}{= 4}
                ...
                \begin{center}
                    \begin{tikzpicture}
                        \begin{axis}[
                            axis on top=true,
                            axis line style=thick,
                            no markers, domain=0:20, samples=20,
                            axis lines*=left, xlabel=$x_1$, ylabel=$x_2$,
                            ...
                            \addplot[fill=black!20, draw=none, domain=0:4] {6 - \x/3} \closedcycle;

                            \addplot[thick] {6 - \x/3};
                            \addplot[thick] coordinates {(4, 0) (4, 10)};

                            \addplot[thick, violet] {38/3 - 2*\x};
                            \addplot[thick, teal] {6 - 2*\x};
                        \end{axis}
                    \end{tikzpicture}
                \end{center}
                ...
                \begin{center}
                    \begin{tikzpicture}
                        \begin{axis}[
                            axis on top=true,
                            axis line style=thick,
                            no markers, domain=0:15, samples=45,
                            axis lines*=left, xlabel=$p_1$, ylabel=$v(p_1)$,
                            height=7cm, width=14cm,
                            enlargelimits=false,
                            xtick={0,1,...,20},
                            ytick={-10,-9,...,1},
                            ...
                            \addplot[thick] coordinates {(0, 0) (6, -6) (38/3, -26/3) (15, -26/3)};
                        \end{axis}
                    \end{tikzpicture}
                \end{center}
                ...
                \begin{center}
                    \begin{tikzpicture}
                        \begin{axis}[
                            ...
                            \addplot[thick] coordinates {(0, 0) (6, -6)};
                            \addplot[thick, violet] coordinates {(6, -6) (38/3, -26/3)};
                            \addplot[thick] coordinates {(38/3, -26/3) (15, -26/3)};

                            \addplot[dashed] coordinates {(0, -6) (6, -6)};
                            \addplot[dashed] coordinates {(6, -10) (6, -6)};

                            \addplot[dashed] coordinates {(0, -26/3) (38/3, -26/3)};
                            \addplot[dashed] coordinates {(38/3, -10) (38/3, -26/3)};
                        \end{axis}
                    \end{tikzpicture}
                \end{center}
                Let $p_1 = b_1 = 11$.
                ...
                \begin{enumerate}[1.]
                    ...
                    \item Write the dual formulation of the following (primal) linear program;
                        \begin{mini*}|l|
                            {}{-x_1 + x_2}
                            {}{}
                            \addConstraint{2x_1 + x_2}{\leq 10}
                            \addConstraint{3x_1 + 7x_2}{\geq 20}
                            \addConstraint{x_1, x_2}{\geq 0}
                        \end{mini*}
                        ...
                        \begin{maxi*}|l|
                            {}{-10y_1 + 20y_2}
                            {}{}
                            \addConstraint{-2y_1 + 3y_2}{\leq -1}
                            \addConstraint{-y_1 + 7y_2}{\leq 1}
                            \addConstraint{y_1, y_2}{\geq 0}
                        \end{maxi*}
                \end{enumerate}
        \subsection*{Lecture 12}
            ...
            \subsubsection*{Column Player's Perspective}
                From CP's perspective, they expect RP to respond with optimal $p_i$ for any choice of $q_j$, how should CP choose $q_j$'s?
                $$V_{CP} = \min_{q_1, \dots, q_n} \overbrace{\max_{p_1, \dots, p_m} \underbrace{\summation{i = 1}{m} \summation{j = 1}{n} p_i q_j a_{i, j}}_{V(\vec{p}, \vec{q})}}^{V^{in}_{CP}(\vec{q})}$$
                If we only consider the inner problem, it is a function of $q_j$, call the problem $V^{in}_{CP}$.
                We can focus on the inner problem as follows;
                \begin{mini*}|l|
                    {}{V_{CP} = V^{in}_{CP}(q_1, \dots, q_n)}
                    {}{}
                    \addConstraint{\summation{j = 1}{n} q_j}{= 1}
                    \addConstraint{q_j}{\geq 0}
                \end{mini*}
                For any choice of $q_j$'s, let $\alpha_i = \summation{j = 1}{n} q_j a_{i, j}$ be row payoffs.
                The inner maximisation problem then becomes the following;
                \begin{maxi*}|l|
                    {}{V^{in}_{CP}(q_1, \dots, q_n) = \summation{i = 1}{m} p_i \alpha_i}
                    {}{}
                    \addConstraint{\summation{i = 1}{m} p_i}{= 1}
                    \addConstraint{p_i}{\geq 0}
                \end{maxi*}
                However, the solution is trivial, as we can set $p_i = 1$ for the largest $\alpha_i$, and $p_k = 0$ when $k \neq i$.
                From this, we have the inner maximisation optimal value as;
                $$V^{in}_{CP}(q_1, \dots, q_n) = \max \{\alpha_1, \dots, \alpha_m\}$$
                By expanding the definition of $\alpha_i$, we conclude CP is solving a min-max problem;
                $$V_{CP} = \min_{q_1, \dots, q_n} \max \left\{\summation{j = 1}{n} q_j a_{1, j}, \dots, \summation{j = 1}{n} q_j a_{m, j}\right\}$$
                Subject to the probability constraints on $q_j$.
                This simplification removes $p_i$ from the problem entirely.
                \begin{mini*}|l|
                    {}{\tau}
                    {}{}
                    \addConstraint{\tau}{\geq \summation{j = 1}{n} q_j a_{i, j}\ \ \ \forall i = 1, \dots, m}
                    \addConstraint{\summation{j = 1}{n} q_j}{= 1}
                    \addConstraint{q_j}{\geq 0}
                \end{mini*}
                As such, we have the optimal $q^*_j$'s being independent of $p^*_i$'s.
            \subsubsection*{Row Player's Perspective}
                Similar reasoning applies to the choice of the row player;
                $$V_{RP} = \max_{p_1, \dots, p_m} \min_{q_1, \dots, q_n} \summation{i = 1}{m} \summation{j = 1}{n} p_i q_j a_{i, j}$$
                \begin{maxi*}|l|
                    {}{\tau}
                    {}{}
                    \addConstraint{\tau}{\leq \summation{i = 1}{m} p_i a_{i, j}\ \ \ \forall j = 1, \dots, n}
                    \addConstraint{\summation{i = 1}{m} p_i}{= 1}
                    \addConstraint{p_i}{\geq 0}
                \end{maxi*}
            \subsubsection*{Minimax Theorem}
                ...
                \begin{center}
                    \begin{tabular}{|cc|ccc|}
                        ...
                        & & L & B & S \\
                        \hline
                        \multirow{3}{*}{RP} & L & $0$ & $-1$ & $2$ \\
                        & B & $5$ & $4$ & $-3$ \\
                        & S & $2$ & $3$ & $-4$ \\
                        \hline
                    \end{tabular}
                \end{center}
                This leads to the following results, for $\vec{p^*}$ and $\vec{q^*}$;
                \begin{center}
                    \vspace{-\baselineskip}
                    \hfill
            ...
            \subsubsection*{Integer Programming}
                ...
                \begin{maxi*}|l|
                    {}{x + y}
                    {}{}
                    \addConstraint{-2x + 2y}{\geq 1}
                    \addConstraint{-8x + 10y}{\leq 13}
                    \addConstraint{x, y}{\geq 0}
                    \addConstraint{x, y}{\in \mathbb{N}_0}
                \end{maxi*}
            ...
            \subsubsection*{Example}
                A company has resources $i \in \{1, \dots, m\}$, and resource $i$ has a limited availability of $b_i$.
                A company can undertake projects $j \in \{1, \dots, n\}$, and project $j$ requires $a_{i, j}$ units of resource $i$ and gives revenue $c_j$.
                Which projects should be undertaken?
                \begin{maxi*}|l|
                    {}{z = \summation{j = 1}{n} c_j x_j}
                    {}{}
                    \addConstraint{\summation{j = 1}{n} a_{i, j} x_j}{\leq b_j}{\ \ \ \forall i \in \{1, \dots, m\}}
                    \addConstraint{x_j}{\in \{0, 1\}}{\ \ \ \forall j \in \{1, \dots, n\}}
                \end{maxi*}
                Consider another example where a company has $m$ potential distribution sites, labelled $i \in \{1, \dots, m\}$, and building site $i$ costs $f_i$.
                The company has $n$ customers, labelled $j \in \{1, \dots, n\}$, whose demands $d_j$ need to be satisfied from one or more distribution centres.
                The cost to satisfy an amount $x_{i, j}$ of a customer $j$'s demand from distribution centre $i$ is $c_{i, j}$ if $i$ is built.
                Which centres should be built, and how should the demand be satisfied, to minimise cost?
                \begin{mini*}|l|
                    {}{\underbrace{\summation{i = 1}{m} f_i y_i}_\text{build} + \underbrace{\summation{i = 1}{m} \summation{j = 1}{n} c_{i, j} x_{i, j}}_\text{dispatch}}
                    {}{}
                    \addConstraint{\summation{i = 1}{m} x_{i, j}}{= d_j}{\ \ \ \forall j \in {1, \dots, n}}
                    \addConstraint{x_{i, j}}{\leq d_j y_i}{\ \ \ \forall i \in {1, \dots, m}, j \in {1, \dots, n}}
                    \addConstraint{x_{i, j}}{\geq 0}{\ \ \ \forall i \in {1, \dots, m}, j \in {1, \dots, n}}
                    \addConstraint{y_i}{\in \{0, 1\}}{\ \ \ \forall i \in {1, \dots, m}}
                \end{mini*}
                Constraint one states that the demand must be satisfied and constraint two states that $x_{i, j}$ can only exist if the facility is built.
            \subsubsection*{Combinatorial Optimisation}
                Combinatorial optimisation problems involving finding an optimal object from a finite set of objects - enumeration becomes intractable as the problem size grows.
                These problems are often reducible to a few categories;
                \begin{itemize}
                    \itemsep0em
                    \item \textbf{knapsack problem}
                        \smallskip

                        Consider $n$ items of weight $w_j$, $j \in \{1, \dots, n\}$, and a knapsack of capacity $W$.
                        Item $j$ has value $v_j$, but not all items may fit the knapsack - we want to optimise this value.
                        \begin{maxi*}|l|
                            {}{z = \summation{j = 1}{n} v_j x_j}
                            {}{}
                            \addConstraint{\summation{j = 1}{n} w_j x_j}{\leq W}
                            \addConstraint{x_j}{\in \{0, 1\}}
                        \end{maxi*}
                    \item \textbf{bin-packing problem}
                        \smallskip

                        Similarly, consider $n$ items of weight $w_j$, $j \in \{1, \dots, n\}$, and $k$ bins of capacity $W$.
                        Our goal is to minimise the number of bins needed to store all items.
                        \begin{mini*}|l|
                            {}{z = \summation{i = 1}{k} y_i}
                            {}{}
                            \addConstraint{\summation{j = 1}{n} w_j x_{i, j}}{\leq Wy_i}
                            \addConstraint{\summation{i = 1}{k} x_{i, j}}{= 1}
                            \addConstraint{x_{i, j}, y_i}{\in \{0, 1\}}
                        \end{mini*}
                        The second constraint says that each item is in exactly one bin.
                    \item (and more)
                \end{itemize}
        \subsection*{Lecture 13}
            \subsubsection*{Mixed Integer Linear Programming}
                ...
                \begin{enumerate}[1.]
                    ...
                    \item apply LP standard form transformations, except addition of slack and excess variables;
                        ...
                        \end{itemize}
                        \begin{mini*}|l|
                            {}{z = -\frac{1}{3}x_1 - \frac{1}{2}x_2}
                            {}{}
                            \addConstraint{\frac{2}{3}x_1 + \frac{1}{3}x_2}{\leq \frac{4}{3}}
                            \addConstraint{\frac{1}{2}x_1 - \frac{3}{2}x_2}{\leq \frac{2}{3}}
                            \addConstraint{x_1, x_2}{\geq 0}
                            \addConstraint{x_1, x_2}{\in \mathbb{N}_0}
                        \end{mini*}
                    ...
                    \item insert integer slack / excess variables
                        \begin{mini*}|l|
                            {}{z^\prime = -2x_1 - 3x_2}
                            {}{}
                            \addConstraint{2x_1 + x_2 + s_3}{= 4}
                            \addConstraint{3x_1 - 9x_2 + s_4}{= 4}
                            \addConstraint{x_1, x_2, s_3, s_4}{\geq 0}
                            \addConstraint{x_1, x_2, s_3, s_4}{\in \mathbb{N}_0}
                        \end{mini*}
            ...
            \subsubsection*{Logical Operations}
                ...
                \begin{mini*}|l|
                    ...
                    {}{}
                    \addConstraint{x}{\geq 0}
                    \addConstraint{x}{\leq 4}
                    \addConstraint{x}{\leq 1 + M\delta}
                    \addConstraint{x}{\geq 2 - M(1 - \delta)}
                \end{mini*}
        ...
        \subsection*{Lecture 14}
            ...
            \subsubsection*{Cutting Plane Algorithm}
                ...
                \begin{maxi*}|l|
                    {}{y = 5x_1 + 8x_2}
                    {}{}
                    \addConstraint{x_1 + x_2}{\leq 6}
                    \addConstraint{5x_1 + 9x_2}{\leq 45}
                    \addConstraint{x_1, x_2}{\geq 0}
                    \addConstraint{x_1, x_2}{\in \mathbb{N}_0}
                \end{maxi*}
            ...
            \subsubsection*{Worked Example}
                ...
                \begin{maxi*}|l|
                    {}{y = 3x_1 + 4x_2}
                    {}{}
                    \addConstraint{\frac{2}{5}x_1 + x_2}{\leq 3}
                    \addConstraint{\frac{2}{5}x_1 - \frac{2}{5}x_2}{\leq 1}
                    \addConstraint{x_1, x_2}{\geq 0}
                    \addConstraint{x_1, x_2}{\in \mathbb{N}_0}
                \end{maxi*}
                ...
                \begin{mini*}|l|
                    {}{z = -3x_1 + -4x_2}
                    {}{}
                    \addConstraint{2x_1 + 5x_2 + x_3}{= 15}
                    \addConstraint{2x_1 - 2x_2 + x_4}{= 5}
                    \addConstraint{x_1, x_2, x_3, x_4}{\geq 0}
                    \addConstraint{x_1, x_2, x_3, x_4}{\in \mathbb{N}_0}
                \end{mini*}
        ...
        \subsection*{Lecture 15}
            \subsubsection*{Divide and Conquer Continued}
                ...
                \begin{center}
                    \begin{tikzpicture}
                        \node[draw, circle] (p0) at (0, 0) {$P_0$};
                        \node[draw, circle] (p1) at (-2, -2) {$P_1$};
                        \node[draw, circle] (p2) at (2, -2) {$P_2$};
                        \node[draw, circle] (p3) at (1, -4) {$P_3$};
                        \node[draw, circle] (p4) at (3, -4) {$P_4$};

                        \draw
                        (p0) edge[->, left] node{$y_j \leq \floor{y^*_j}$} (p1)
                        (p0) edge[->, right] node{$y_j \geq \ceil{y^*_j}$} (p2)
                        (p2) edge[->, left] node{$y_k \leq \floor{y^*_k}$} (p3)
                        (p2) edge[->, right] node{$y_k \geq \ceil{y^*_k}$} (p4);
                    \end{tikzpicture}
                \end{center}
                ...
                \begin{mini*}|l|
                    ...
                    {}{}
                    \addConstraint{\mat{A}\vec{x}}{= \vec{b}}
                    \addConstraint{x_j}{\geq 0}{\ \ \ \text{for } j \in N = {1, \dots, n}}
                    \addConstraint{x_j}{\in \mathbb{N}_0}{\ \ \ \text{for } j \in Z \subseteq N}
                \end{mini*}
