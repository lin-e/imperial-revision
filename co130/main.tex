    ...
    \section*{CO130 - Databases}
        ...
        \subsection*{Functional Dependencies}
            ...
            \subsubsection*{Covers}
                We can say two FD sets $F_1$, and $F_2$ are equivalent if they each imply the other - if any relation insance satisfying $F_1$ also satisfies $F_2$, they are said to be covers of each other.
\end{document}
