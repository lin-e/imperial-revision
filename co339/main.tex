...
\begin{document}
    ...
    \section*{CO339 - Performance Engineering \hfill (60017)}
        \subsection*{Introduction}
            ...
            The problem is usually `high value', with some significant benefit, is realtively simple (narrowly scoped, however speed is difficult), and is occasionally supported by special hardware, such as GPUs or tensor processing units built to support ML workloads.
            \medskip

            However, performance engineering fcuses on systems (complex, flexible pieces of software).
            ...
            These are usually applicable to multiple problems or domains (they are generic); this differs from a well-designed application as the goal is domain-agnositc, hence they are designed to be flexible at runtime - for example, we don't want to recompile ~grep~ every time we want to search for a string.
            \medskip
            ...
            Software systems are complex and developed over years, and therefore must be maintainbale.
            ...
            \begin{center}
                ...
                \end{tikzpicture}
            \end{center}
            Instead of having only flexible and fast code, we need to think about what parts should be prioritised for flexibility, what parts for speed, and what parts should be maintainble.
                ...
                \begin{enumerate}[1.]
                    ...
                    \item \textbf{define a target metric}
                        \begin{itemize}
                            ...
                            \item \textbf{memory usage} \hfill stay within memory constraitns
                            \item \textbf{energy consumption} \hfill energy related to cooling in data centers
                    ...
                    \item \textbf{decide when requirements are met}
                        ...
                        These are often referred to as \textbf{Quality-of-Service (QoS)} objetives.
                        \medskip
                        ...
                        This can sometimes conflict with functional requirements (the previous example may conflict with the realisim of the AI in a game).
                        \medskip
            ...
            \subsubsection*{Performance Evaluation Techniques}
                ...
                Based on \textbf{instrumentation}, and can be difficult as we want to reduce the effect of the benchmarking on the acutal performance of the production system.
                \medskip
                ...
                After this, a series of operations (the workload) is performed with relavent metrics measured.
