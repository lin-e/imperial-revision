...
\begin{document}
    \section*{CO240 - Models of Computation}
        ...
        \subsection*{20th November 2019 \hfill Lecture}
            ...
            On the other hand, we return $X^\prime = x$, and $L^\prime = \ell$, if the inital state is $L = \lla x, \ell \rra$.
            \begin{center}
                \begin{tikzpicture}[x=1.5cm, y=1.5cm]
                    \node (en) at (0, 0) {entry};
                    \node (xm) at (1, 0) {$X^-$};
            ...
            \subsubsection*{The Universal Register Machine}
                ...
                \begin{enumerate}[1.]
                    ...
                    \item if $N = 0$, then halt, otherwise $N = \lla y, z \rra$, then set $C = y, N = z$, and go to step 3.
                        ...
                        \subitem note that in this case, when we say $R_i$, we're refering to the register in the \textbf{simulated} machine not the \textbf{universal} machine.
                ...
                \begin{center}
                    \begin{tikzpicture}[x=3cm, y=2cm]
                        ...
                        \node (np) at (3, -3) {$N^+$};
                        \node (cm2) at (4, -3) {$C^-$};
                        \node (purs) at (5, -3) {\shortstack{push $R$ \\ to $S$}};
                        \draw
                        (s) edge[->] (pur0a)
            ...
            \subsubsection*{Halting Problem}
                ...
                As such, $C$ starting with $R_1 = c$ eventually halts iff $H^\prime$ starting with $R_1 = c$ halts with $R_0 = 0$ iff $H$ starting with $R_1 = c, R_2 = \crnr{[c]}$ halts with $R_0$ iff $C$ starting wtih $R_1 = c$ does not halt.
