    ...
    \section*{CO245 - Probability and Statistics}
            ...
            \subsubsection*{Example Models}
                \begin{enumerate}[(I)]
                    ...
                    \item
                        ...
                        $$\bar{x} \sim \text{N}\left(\mu, \frac{\sigma^2}{20}\right)$$
                    \item
        ...
        \subsection*{20th February 2020}
            \subsubsection*{Estimators (Continued)}
                ...
                $$\bar{X} \sim \text{N}\left(E(X), \frac{\text{Var}(X)}{n}\right)$$
        ...
        \subsection*{26th Febuary 2020}
            \subsubsection*{Maximum Likelihood Estimator}
                The general setting is as follows; we have $n$ iid samples with probability distribution function $P_{X|\theta}(x_i)$.
