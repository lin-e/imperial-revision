...
\begin{document}
    \section*{CO245 - Probability and Statistics}
        ...
        \subsection*{5th March 2019 (old Panopto)}
            ...
            \subsubsection*{Example of Hypothesis Testing}
                ...
                \begin{itemize}
                    ...
                    \item Let us choose another significance level of $100\alpha\%$, with $\alpha = 0.01$, thus our rejection region is;
                        ...
                        \end{center}
                        We have $z \notin R$, therefore we retain the null hypothesis at the 1\% level (hence we are 95\% sure that the mean weight is incorrect).
                \end{itemize}
\end{document}