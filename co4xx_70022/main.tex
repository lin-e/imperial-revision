        ...
        \subsection*{5 - Multicores}
            ...
            \begin{itemize}
                ...
                \item \textbf{unscalable components}
                    ...
                    In this process, the first thread commits \textbf{without releasing} hot locks and instead passes them to the next thread which can either release them or use them, and so on.
