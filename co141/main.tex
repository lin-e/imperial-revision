...
G' (i, j, cnt, acc)
  ...
  | otherwise = G' (i, j, cnt + 1, acc + j)\end{verbatim}
            ...
            \subsubsection*{Example 3}
                Consider the DivMod function, defined as $\texttt{DM} : \mathbb{Z} \times \mathbb{Z} \mapsto \mathbb{Z} \times \mathbb{Z}$, and $\texttt{DM'} : \mathbb{Z} \times \mathbb{Z} \times \mathbb{Z} \times \mathbb{Z} \mapsto \mathbb{Z} \times \mathbb{Z}$
\end{document}