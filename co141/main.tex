...
return acc;\end{verbatim}
            ...
            \begin{reasoning}
                ...
                \proofis
                \prooftext{Take arbitrary $m, cnt_1, acc_1 : \mathbb{N}$}
                \prooftext{Inductive hypothesis: $k = m - cnt_1 \rightarrow \texttt{M'}(m, cnt_1, acc_1) = 2^{m - cnt_1} \cdot acc_1$}
                \prooftext{To show: $k + 1 = m - cnt \rightarrow \texttt{M'}(m, cnt, acc) = 2^{m - cnt} \cdot acc$}
                \prooftext{Take arbitrary $cnt : \mathbb{N}$}
                ...
                % \proofline{1}{k = m - (cnt + 1)}{by arithmetic}
                % \proofline{2}{k = m - cnt_1}{where $cnt_1 = cnt + 1$}
                % \proofline{3}{\texttt{M'}(m, cnt_1, acc) = 2^{m - cnt_1} \cdot acc}{by inductive hypothesis}
                % \proofline{1}{k \geq 0}{by $k : \mathbb{N}$}
                % \proofline{2}{k + 1\geq 1}{by arithmetic}
                % \proofline{3}{m - cnt \geq 1}{by (2), and arithmetic}
                % \proofline{4}{m \geq cnt + 1}{by arithmetic}
