        ...
        \subsection*{Induction over Natural Numbers}
            ...
            \subsubsection*{Example - Sum of Natural Numbers}
                ...
                \begin{reasoning}
                    ...
                    \proofmath{\summation{i = 0}{0}{i}}{0}{by definition of $\sum$}
                    \proofmath{}{\frac{0(1)}{2}}{by arithmetic}
                    \proofmath{}{\frac{0(0 + 1)}{2}}{by arithmetic}
                    \proofis
                    ...
                    \proofmath{\summation{i = 0}{k + 1}{i}}{\summation{i = 0}{k}{i} + (k + 1)}{by definition of $\sum$}
                    \proofmath{}{\frac{k(k + 1)}{2} + (k + 1)}{\textcolor{blue}{by inductive hypothesis}}
                    \proofmath{}{\frac{k^2 + 3k + 2}{2}}{by arithmetic}
                    \proofmath{}{\frac{(k + 1)(k + 2)}{2}}{by arithmetic}
                    \proofmath{}{\frac{(k + 1)((k + 1) + 1)}{2}}{by arithmetic}
                \end{reasoning}
            \subsubsection*{Example - $7^n + 5$ is divisible by 3}
                ...
                \begin{reasoning}
                    ...
                    \proofmath{7^0 + 5}{1 + 5}{by arithmetic}
                    \proofmath{}{6}{by arithmetic}
                    \proofmath{}{3 \cdot 2}{by arithmetic}
                    ...
                    \proofmath{7^{k + 1} + 5}{7 \cdot 7^k + 5}{by arithmetic}
                    \proofmath{}{(6 + 1) \cdot 7^k + 5}{by arithmetic}
                    \proofmath{}{(6 \cdot 7^k + 7^k) + 5}{by arithmetic}
                    \proofmath{}{3 \cdot (2 \cdot 7^k) + (7^k + 5)}{by arithmetic}
                    \proofmath{}{3 \cdot (2 \cdot 7^k) + 3 \cdot m_1}{by (1)}
                    \proofmath{}{3 \cdot [2 \cdot 7^k + m_1]}{by arithmetic}
...
f n = 1/(n * (n + 1)) + f (n - 1)\end{verbatim}
                ...
                \begin{reasoning}
                    ...
                    \proofmath{\texttt{f } 1}{\frac{1}{2}}{by def. of \texttt{f}}
                    \proofmath{}{\frac{1}{1 + 1}}{by arithmetic}
                    \proofis
                    ...
                    \proofmath{\texttt{f } (k + 1)}{\frac{1}{(k + 1)(k + 2)} + \texttt{f } k}{by def. of \texttt{f}, and (a1)}
                    \proofmath{}{\frac{1}{(k + 1)(k + 2)} + \frac{k}{k + 1}}{by inductive hypothesis}
                    \proofmath{}{\frac{1}{(k + 1)(k + 2)} + \frac{k(k + 2)}{(k + 1)(k + 2)}}{by arithmetic}
                    \proofmath{}{\frac{k^2 + 2k + 1}{(k + 1)(k + 2)}}{by arithmetic}
                    \proofmath{}{\frac{(k + 1)^2}{(k + 1)(k + 2)}}{by arithmetic}
                    \proofmath{}{\frac{k + 1}{k + 2}}{by arithmetic}
                \end{reasoning}
...
g n = (5 * g (n - 1)) - (6 * g (n - 2))\end{verbatim}
                ...
                \begin{reasoning}
                    ...
                    \proofmath{\texttt{g } 0}{0}{by def. of \texttt{g}}
                    \proofmath{}{1 - 1}{by arithmetic}
                    \proofmath{}{3^0 - 2^0}{by arithmetic}
                    \proofis
                    \prooftext{Take arbitrary $k : \mathbb{N}\ (k \neq 0)$}
                    \prooftext{Case 1: $k = 0$}
                    \prooftext{To show: $\texttt{g } 1 = 3^1 - 2^1$}
                    \proofmath{\texttt{g } 1}{1}{by def. of \text{g}}
                    \proofmath{}{3 - 2}{by arithmetic}
                    \proofmath{}{3^1 - 2^1}{by arithmetic}
                    \prooftext{Case 2: $k \neq 0$}
                    ...
                    \proofmath{\texttt{g } (k + 1)}{5 \cdot \texttt{g } k - 6 \cdot \texttt{g } (k - 1)}{by (1), and def. of \text{g}}
                    \proofmath{}{5 \cdot (3^k - 2^k) - 6 \cdot (3^{k - 1} - 2^{k - 1})}{by (2), and inductive hypothesis}
                    \proofmath{}{5 \cdot 3 \cdot 3^{k - 1} - 5 \cdot 2 \cdot 2^{k - 1} - 6 \cdot 3^{k - 1} + 6 \cdot 2^{k - 1}}{by arithmetic}
                    \proofmath{}{9 \cdot 3^{k - 1} - 4 \cdot 2^{k - 1}}{by arithmetic}
                    \proofmath{}{3^{k + 1} - 2^{k + 1}}{by arithmetic}
                \end{reasoning}
