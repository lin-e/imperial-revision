...
% actual document
\begin{document}
    {\sc Computing $2^\text{nd}$ Year Notes} \hfill ~https://github.com/lin-e/imperial-revision~
    \rule{\textwidth}{0.1pt}
    \section*{CO233 - Computational Techniques}
        \subsection*{15th January 2020}
            \subsubsection*{Vector and Matrix Norms}
                ...
                \begin{center}
                    $\Vert \vec{v} \Vert_2 = \sqrt{\summation{i=1}{n} v_i^2}$
                \end{center}
                A norm, a mapping $\Vert\ \Vert : \mathbb{R}^n \to \mathbb{R}^+$, must satisfy these 3 axioms;
                \begin{enumerate}[(i)]
                    \itemsep0em
                    \item $\Vert \vec{v} \Vert > 0$ given that $\vec{v} \neq \vec{0}$
                    \item $\Vert \lambda \vec{v} \Vert = |\lambda|\ \Vert \vec{v} \Vert$
                    \item $\Vert \vec{v} + \vec{w} \Vert \leq \Vert \vec{v} \Vert + \Vert \vec{w} \Vert$ (triangular inequality)
                \end{enumerate}
                Some other ($\ell_p$) norms are defined as follows;
                \begin{align*}
                    \ell_1\text{-norm } \Vert \vec{v} \Vert_1 & = \summation{i=1}{n}|v_i| \\
                    \ell_\infty\text{-norm } \Vert \vec{v} \Vert_\infty & = \max \{|v_i| : 1 \leq i \leq n\} \\
                    \ell_p\text{-norm } \Vert \vec{v} \Vert_p & = \left(\summation{i=1}{n} |v_i|^p\right)^\frac{1}{p}
                \end{align*}
                ...
                \begin{itemize}
                    ...
                    \item $n = 1$
                        \begin{itemize}
                            \itemsep0em
                            \item $\Vert \vec{v} \Vert_1 = | v | = | v |$
                            \item $\Vert \vec{v} \Vert_2 = \sqrt{v^2} = | v |$
                            \item $\Vert \vec{v} \Vert_\infty = \max \{| v |\} = | v |$
                        \end{itemize}
                    \item $n = 2$
                        \smallskip
                        ...
                        \begin{center}
                            ...
                            \end{tikzpicture}
                        \end{center}
                        In our case $\Vert \vec{v} \Vert_\infty = \max\{ | v_1 |, | v_2 | \} = | v_1 |$, but the point is that it's either of the "sides" of the triangle.
                        Obviously, $\Vert \vec{v} \Vert_2 \geq \Vert \vec{v} \Vert_\infty$, as it's the hypotenuse of the triangle, and similarly, $\Vert \vec{v} \Vert_1 \geq \Vert \vec{v} \Vert_2$, due to the triangle inequality.
                        Therefore we have $\Vert \vec{v} \Vert_1 \geq \Vert \vec{v} \Vert_2 \geq \Vert \vec{v} \Vert_\infty$.
                        \smallskip
                    ...
                    \item $n =\ ?$ (general)
                        ...
                        The goal is to prove $\Vert \vec{v} \Vert_\infty \leq \Vert \vec{v} \Vert_2 \leq \Vert \vec{v} \Vert_1$.
                        If we first take the squares of all of them, such that we have the following;
                        \begin{align*}
                            \Vert \vec{v} \Vert_1^2 & = \left(\summation{i = 1}{n} | v_i |\right)^2 \\
                            \Vert \vec{v} \Vert_2^2 & = \summation{i = 1}{n} | v_i |^2 \\
                            \Vert \vec{v} \Vert_\infty^2 & = (\max\{| v_i | : 1 \leq i \leq n\})^2 \\
                        \end{align*}
                        ...
                        \begin{center}
                            $\Vert \vec{v} \Vert_2^2 = \summation{i = 1}{n} | v_i |^2 \geq (\max\{| v_i | : 1 \leq i \leq n\})^2 = \Vert \vec{v} \Vert_\infty^2 \Rightarrow \Vert \vec{v} \Vert_2 \geq \Vert \vec{v} \Vert_\infty$
                        \end{center}
                        ...
                        \begin{center}
                            $\Vert \vec{v} \Vert_2^2 = \summation{i = 1}{n} | v_i |^2 \leq \left(\summation{i = 1}{n} | v_i |\right)^2 = \Vert \vec{v} \Vert_\infty^1 \Rightarrow \Vert \vec{v} \Vert_2 \leq \Vert \vec{v} \Vert_1$
                        \end{center}
                        As such, we can conclude that $\Vert \vec{v} \Vert_\infty \leq \Vert \vec{v} \Vert_2 \leq \Vert \vec{v} \Vert_1$ in any dimension. \hfill $\blacksquare$
                \end{itemize}
            \subsubsection*{Tutorial Question}
                Find the locus of vectors such that $\Vert \vec{v} \Vert_p \leq 1$, for $p = \red{1}, \blue{2}, \violet{\infty}$ in $n = 2$;
                \begin{center}
                    \begin{tikzpicture}
                        \node at (1.75, 0) {$x$};
                        \node at (0, 1.75) {$y$};
            ...
            \subsubsection*{$\ell_p$-norm}
                ...
                \begin{center}
                    $\Vert \vec{v} \Vert_p^p = \summation{i = 1}{n} | v_i |^p$
                \end{center}
                Obviously, this is greater than or equal to $\Vert \vec{v} \Vert_\infty^p$, as it would only be a single $| v_i |^p$.
                Similarly, it must be less than or equal to $n | v_i |^p$, as $v_i$ is the maximum of all the components.
                \begin{center}
                    $\Vert \vec{v} \Vert_\infty^p \leq \Vert \vec{v} \Vert_p^p = \summation{i = 1}{n} | v_i |^p \leq n \Vert \vec{v} \Vert_\infty^p$
                \end{center}
                Taking everything to the power of $\frac{1}{p}$, we obtain the following result (note that $p > 0$ hence the signs don't change);
                \begin{center}
                    $\Vert \vec{v} \Vert_\infty \leq \Vert \vec{v} \Vert_p = \leq n^\frac{1}{p} \Vert \vec{v} \Vert_\infty$
                \end{center}
            ...
            \subsubsection*{Some Proposition ($\ell_\infty$-norm vs $\ell_2$-norm)}
                The proposition is as follows; for a vector $\vec{v} \in \mathbb{R}^n$, $\Vert \vec{v} \Vert_2 \leq \sqrt{n} \Vert \vec{v} \Vert_\infty$.
                To show this, we know that each of $| v_i |$ is less than or equal to $\Vert \vec{v} \Vert_\infty$, by definition of the maximum.
                The same can be said for $| v_i |^2$, vs $\Vert \vec{v} \Vert_\infty^2$.
                Taking square roots, we have the following;
                \begin{center}
                    $\Vert \vec{v} \Vert_2^2 = \summation{i = 1}{n} | v_i |^2 \leq n \Vert \vec{v} \Vert_\infty^2 \Rightarrow \Vert \vec{v} \Vert_2 \leq \sqrt{n} \Vert \vec{v} \Vert_\infty$
                \end{center}
                To show this holds similarly for $\Vert \vec{v} \Vert_1 \leq \sqrt{n} \Vert \vec{v} \Vert_2$, we employ the Cauchy-Schwarz inequality, which states $| \vec{x} \cdot \vec{y} | \leq \Vert \vec{x} \Vert_2 \Vert \vec{y} \Vert_2$.
                The Cauchy-Schwarz inequality uses the fact that $\vec{x} \cdot \vec{y} = \Vert \vec{x} \Vert_2 \Vert \vec{y} \Vert_2 \cos \theta$.
                ...
                \begin{align*}
                    ...
                    & = \sqrt{n} \Vert \vec{v} \Vert_1 \\
                    \Vert \vec{w} \Vert_2 & = \summation{i = 1}{n} \frac{\pm 1}{\sqrt{n}}^2 \\
                    & = \summation{i = 1}{n} \frac{1}{n} \\
                    & = 1
                \end{align*}
                By \violet{Cauchy-Schwarz}, we get;
                \begin{center}
                    $\sqrt{n} \Vert \vec{v} \Vert_1 = \violet{| \vec{v} \cdot \vec{w} | \leq \Vert \vec{v} \Vert_2 \Vert \vec{w} \Vert_2} = \Vert \vec{v} \Vert_2$
                \end{center}
        \subsection*{16th January 2020}
            ...
            \subsubsection*{Equivalence of Norms?}
                Take any two norms on $\mathbb{R}^n$; $\Vert\ \Vert_a$, and $\Vert\ \Vert_b$.
                \begin{center}
                    $\exists r, s \in \mathbb{R}^+\ \forall \vec{v} \in \mathbb{R}^n\ [r \Vert \vec{v} \Vert_b \leq \Vert \vec{v} \Vert_a \leq s \Vert \vec{v} \Vert_b]$
                \end{center}
            ...
            \subsubsection*{Convergence of Vector Sequences}
                ...
                \begin{center}
                    $\vec{v}^{(m)} \to \vec{v} \in \mathbb{R}^n \Leftrightarrow \limit{m}{\infty} \Vert \vec{v}^{(m)} - \vec{v} \Vert \to 0$
                \end{center}
                This is componentwise convergence, such that $\forall i \in [1, n]\ [v_i^{(m)} \to v_i]$.
            \subsubsection*{Matrix Norms}
                Vectors are a type of matrix.
                For a matrix $\mat{A} \in \mathbb{R}^{m \times n}$, the following properties of its norms must hold, where $\Vert\ \Vert : \mathbb{R}^{m \times n} \to \mathbb{R}_{\geq 0}$;
                \begin{enumerate}[(i)]
                    \itemsep0em
                    \item $\Vert \mat{A} \Vert > 0$ given that $\mat{A} \neq \mat{0}$
                    \item $\Vert \lambda \mat{A} \Vert = | \lambda | \Vert \mat{A} \Vert$
                    \item $\Vert \mat{A} + \mat{B} \Vert \leq \Vert \mat{A} \Vert + \Vert \mat{B} \Vert$
                    \item $\Vert \mat{B} \mat{A} \Vert \leq \Vert \mat{B} \Vert \Vert \mat{A} \Vert$
                \end{enumerate}
                \begin{center}
                    \begin{tikzpicture}
                        \node (v) at (0, 0) {$\vec{v} \in \mathbb{R}^n$};
                        \node at (0, -0.75) {$\Vert\ \Vert_a$};
                        \node (av) at (6, 0) {$\mat{A} \vec{v} \in \mathbb{R}^m$};
                        \node at (6, -0.75) {$\Vert\ \Vert_b$};
                        \node at (3, 0) {$\mat{A}$};
                        \draw
                        (v) edge[->] (2, 0)
                        (4, 0) edge[->] (av)
                    ...
                    $\Vert \mat{A} \vec{v} \Vert_b \leq \Vert \mat{A} \Vert \Vert \vec{v} \Vert_a$
                \end{center}
                ...
                \begin{align*}
                    \Vert \mat{A} \Vert_1 & = \max \{\Vert a_j \Vert_1 : 1 \leq j \leq n \} \\
                    \Vert \mat{A} \Vert_\infty & = \max \{\Vert (a^i)^\top \Vert_1 : 1 \leq i \leq m \} \\
                    \Vert \mat{A} \Vert_F & = \sqrt{\summation{i = 1}{m} \summation{j = 1}{n} | a_{i, j} |^2} & \text{Frobenius norm} \\
                    \Vert \mat{A} \Vert_2 & = \text{largest singular value of } \mat{A} \\
                    \text{let } \mat{A} & = \begin{bmatrix}
                        2 & 3 & 1 & 4 \\
                        1 & 3 & -1 & 5 \\
                        \sqrt{2} & 0 & -2 & 2
                    \end{bmatrix} \\
                    \Vert \mat{A} \Vert_1 & = \max \{ 3 + \sqrt{2}, 6, 4, 11 \}
                    \\
                    & = 11 \\
                    \Vert \mat{A} \Vert_\infty & = \max \{ 10, 10, 4 + \sqrt{2} \} \\
                    & = 10 \\
                    \Vert \mat{A} \Vert_F & = \sqrt{4 + 9 + 1 + 16 + 1 + 9 + 1 + 25 + 2 + 0 + 4 + 4} \\
                    & = 2 \sqrt{19}
                \end{align*}
                Let there be two vector norms, $\Vert\ \Vert_a$ on $\mathbb{R}^n$ and $\Vert\ \Vert_b$ on $\mathbb{R}$.
                If $\Vert\ \Vert$ (matrix norm) satisfies
                \begin{center}
                    $\forall \mat{A} \in \mathbb{R}^{m \times n}, x \in \mathbb{R}^n\ [\Vert \mat{A}\vec{x} \Vert_b \leq \Vert \mat{A} \Vert \Vert \vec{x} \Vert_a]$
                \end{center}
                then $\Vert\ \Vert$ is \textbf{consistent} with $\Vert\ \Vert_a$ and $\Vert\ \Vert_b$.
                Additionally if $a = b$, then $\Vert\ \Vert$ is \textbf{compatible} with $\Vert\ \Vert_a$.
                This gives us the following propositions;
                \begin{itemize}
                    \itemsep0em
                    \item $\Vert\ \Vert_1$ (matrix norm) is compatible with $\Vert\ \Vert_1$ (vector norm)
                    \item $\Vert\ \Vert_2$ (matrix norm) is compatible with $\Vert\ \Vert_2$ (vector norm)
                    \item $\Vert\ \Vert_\infty$ (matrix norm) is compatible with $\Vert\ \Vert_\infty$ (vector norm)
                    \item $\Vert\ \Vert_F$ (matrix norm) is compatible with $\Vert\ \Vert_2$ (vector norm) $\Rightarrow \Vert \mat{A}\vec{x} \Vert_2 \leq \Vert \mat{A} \Vert_F \Vert \vec{x} \Vert_2$
                \end{itemize}
                Given a vector norm $\Vert\ \Vert$ on $\mathbb{R}^n$ then the matrix norm $\Vert\ \Vert$ subordinate to vector norm $\Vert\ \Vert$ is defined by
                \begin{center}
                    $\Vert \mat{A} \Vert = \max \{ \Vert \mat{A}\vec{x} \Vert : \Vert \vec{x} \Vert \leq 1 \} \violet{\ = \max \{ \Vert \mat{A}\vec{x} \Vert : \Vert \vec{x} \Vert = 1 \} = \max \{ \Vert \mat{A}\frac{\vec{x}}{\Vert \vec{x} \Vert} \Vert : \vec{x} \neq \vec{0} \}}$
                \end{center}
                Using this, we can prove property (iii) (see above).
                We claim that $\Vert \mat{A} + \mat{B} \Vert \leq \Vert \mat{A} \Vert + \Vert \mat{B} \Vert$ for matrix norm $\Vert\ \Vert$ subordinate to vector norm $\Vert\ \Vert$.
                \begin{align*}
                    \Vert \mat{A} + \mat{B} \Vert & = \max \{ \Vert (\mat{A} + \mat{B})\vec{x} \Vert : \Vert \vec{x} \Vert \leq 1 \} \\
                    & = \max \{ \Vert \mat{A}\vec{x} + \mat{B}\vec{x} \Vert : \Vert \vec{x} \Vert \leq 1 \} \\
                    & \leq \max \{ \Vert \mat{A}\vec{x} \Vert + \Vert \mat{B}\vec{x} \Vert : \Vert \vec{x} \Vert \leq 1 \} & \text{triangle inequality for $\Vert\ \Vert$} \\
                    & \leq \max \{ \Vert \mat{A}\vec{x} \Vert : \Vert \vec{x} \Vert \leq 1 \} + \max \{ \Vert \mat{B}\vec{x} \Vert : \Vert \vec{x} \Vert \leq 1 \} & \text{maximise independently} \\
                    & = \Vert \mat{A} \Vert + \Vert \mat{B} \Vert & \blacksquare
                \end{align*}
                We are also able to prove property (iv), which we claim to be $\Vert \mat{B}\mat{A} \Vert \leq \Vert \mat{B} \Vert \Vert \mat{A} \Vert$.
                \begin{align*}
                    \Vert \mat{B}\mat{A} \Vert & = \max \{ \Vert \mat{B}\mat{A}\vec{x} \Vert : \Vert \vec{x} \Vert \leq 1 \} \\
                    \Vert \mat{B}\mat{A}\vec{x} \Vert & = \Vert \mat{B}(\mat{A}\vec{x}) \Vert \\
                    \Vert \mat{A}\vec{x} \Vert & \leq \Vert \mat{A} \Vert \Vert \vec{x} \Vert & \text{matrix norm subordinate to vector norm}
                    \intertext{
                    ...
                    \text{show } \left|\left| \mat{A}\frac{\vec{x}}{\Vert \vec{x} \Vert} \right|\right| & \leq \Vert \mat{A} \Vert \\
                    \text{but } \left|\left| \frac{\vec{x}}{\Vert \vec{x} \Vert} \right|\right| & = 1 & \Rightarrow \\
                    \Vert \mat{A}\vec{x} \Vert & \leq \Vert \mat{A} \Vert \Vert \vec{x} \Vert
                    \intertext{Continuing on, we have}
                    \Vert \mat{B}\mat{A}\vec{x} \Vert & = \Vert \mat{B}(\mat{A}\vec{x}) \Vert \\
                    & \leq \Vert \mat{B} \Vert \Vert \mat{A}\vec{x} \Vert \\
                    & \leq \Vert \mat{B} \Vert \Vert \mat{A} \Vert \Vert \vec{x} \Vert \\
                    \Vert \mat{B}\mat{A} \Vert & = \max \{ \Vert \mat{B}\mat{A}\vec{x} \Vert : \Vert \vec{x} \Vert \leq 1 \} \\
                    & \leq \max \{ \Vert \mat{B} \Vert \Vert \mat{A} \Vert \Vert \vec{x} \Vert : \Vert \vec{x} \Vert \leq 1 \} \\
                    & = \Vert \mat{B} \Vert \Vert \mat{A} \Vert \max \{ \Vert \vec{x} \Vert : \Vert \vec{x} \Vert \leq 1 \} & \text{obviously 1, as bounded on top}\\
                    & = \Vert \mat{B} \Vert \Vert \mat{A} \Vert & \blacksquare
                \end{align*}
            \subsubsection*{Complex Vectors}
                ...
                \begin{align*}
                    \vec{v} \cdot \vec{w} & = \Vert \vec{v} \Vert_2 \Vert \vec{w} \Vert_2 \cos \theta_{\vec{v},\vec{w}} \\
                    \vec{v} \cdot \vec{v} & = \sqrt{\Vert \vec{v} \Vert_2^2} \\
                    & = \Vert \vec{v} \Vert_2 \\
        ...
        \subsection*{23rd January 2020}
            ...
            \begin{align*}
                ...
                \mat{B_j} & = \begin{bmatrix}
                    ...
                    & \ddots \\
                    & & \mat{J_j}
                \end{bmatrix} & \text{all $\mat{J_j}$ can be of different sizes, $\mat{B_j} \in \mathbb{R}^{m_j \times m_j}$} \\
            ...
            \subsubsection*{Spectral Decomposition of Symmetric Matrices}
                ...
                \begin{enumerate}[(i)]
                    ...
                    \item All eigenvalues of $\mat{A}$ are real.
                        ...
                        \begin{align*}
                            ...
                            & = \lambda^* \Vert \vec{v} \Vert^2 & (2)
                        \end{align*}
                        By comparing results, $(1) = (2)$, hence $\lambda^* = \lambda$ (dividing through by $\Vert \vec{v} \Vert^2$ is allowed, since we know it is non-zero by properties of vector norms, and $\vec{v} \neq \vec{0}$ by properties of eigenvectors).
                ...
                \begin{itemize}
                    ...
                    \item $\Vert \vec{v_i} \Vert = 1$ for $i = 1, \dots, n$
                \end{itemize}
            ...
            \subsubsection*{Geometric Intuition}
                ...
                \begin{center}
                    ...
                    \end{tikzpicture}
                \end{center}
                Consider a unit sphere, created by $\Vert \vec{x} \Vert = 1$, where $\vec{x} \in \mathbb{R}^3$.
                ...
                \begin{center}
                    $\Vert \vec{u} \Vert_2^2 = u_1^1 + \dots + u_n^2 = 1$
                \end{center}
        ...
        \subsection*{29th January 2020}
            ...
            \subsubsection*{Singular Value Decomposition (SVD)}
                ...
                $\sigma_1$ is the largest singular value of $\mat{A}$, which is the $\ell_2$ matrix norm of $\mat{A}$ ($\Vert \mat{A} \Vert_2$).
                ...
                We still maintain $\Vert \vec{x} \Vert = 1$ and $\Vert \vec{v} \Vert = 1$.
            ...
            \subsubsection*{Example}
                ...
                \begin{align*}
                    ...
                    [\mat{A}\vec{v_1}, \mat{A}\vec{v_2}] & = \mat{U} \begin{bmatrix}
                        ...
                        0 & 0
                    \end{bmatrix} \\
                    & = [\sqrt{6} \vec{u_1}, \vec{0}] & \Rightarrow \\
            ...
            \subsubsection*{Example}
                ...
                \begin{align*}
                    ...
                    \vec{u_1} & = \frac{1}{\sqrt{2}} \begin{bmatrix}
                        1 \\ 1
                    \end{bmatrix} & \text{orthogonal to $\vec{u_2}$} \\
        ...
        \subsection*{5th February 2020}
            ...
            \subsubsection*{Least Square Method}
                ...
                \end{center}
                The goal of the LSM is to find a $\vec{x} \in \mathbb{R}^n$, such that $\Vert \mat{A}\vec{x} - \vec{b} \Vert_2$ is minimised (which is equivalent to minimising $\Vert \mat{A}\vec{x} - \vec{b} \Vert_2^2$, as it is positive).
                From previous results, we can take $\vec{b} = \vec{b_r} + \vec{b_n}$, therefore we can minimise the following;
                \begin{align*}
                    \Vert \mat{A}\vec{x} - \vec{b_r} - \vec{b_n} \Vert_2^2 & = ((\mat{A}\vec{x} - \vec{b_r}) - \vec{b_n}) \cdot ((\mat{A}\vec{x} - \vec{b_r}) - \vec{b_n}) \\
        ...
        \subsection*{6th February 2020}
            ...
            \subsubsection*{Gram-Schmidt Process}
                ...
                \begin{align*}
                    \vec{u_1} & = \vec{a_1} & \vec{e_1} & = \frac{\vec{u_1}}{\Vert \vec{u_1} \Vert} \\
                    \vec{u_2} & = \vec{a_2} - (\vec{e_1} \cdot \vec{a_2}) \vec{e_1} & \vec{e_2} & = \frac{\vec{u_2}}{\Vert \vec{u_2} \Vert} \\
                    \vec{u_3} & = \vec{a_3} - (\vec{e_1} \cdot \vec{a_3}) \vec{e_1} - (\vec{e_2} \cdot \vec{a_3}) \vec{e_2} & \vec{e_2} & = \frac{\vec{u_3}}{\Vert \vec{u_3} \Vert} \\
                    & \vdots & & \vdots \\
                    \vec{u_n} & = \vec{a_n} - \summation{j = 1}{n - 1} (\vec{e_j} \cdot \vec{a_n}) \vec{e_j} & \vec{e_n} & = \frac{\vec{u_n}}{\Vert \vec{u_n} \Vert}
                \end{align*}
            ...
            \subsubsection*{Second Method for QR Decomposition (Householder Operator)}
                ...
                \begin{align*}
                    ...
                    \end{bmatrix}\right) & = \begin{bmatrix}
                        \lambda \\ 0 \\ \vdots \\ 0
                    \end{bmatrix} \\
                    \pm \lambda & = \Vert \vec{a_1} \Vert
                    \intertext{We want to send the vector $\vec{a_1}$ to the vector $\Vert \vec{a_1} \Vert\vec{e_1}$, where $\vec{e_1}$ is all 0, other than the first element.}
                    \vec{u} & = \frac{\vec{a_1} - \Vert \vec{a_1} \Vert\vec{e_1}}{\Vert \vec{a_1} - \Vert \vec{a_1} \Vert\vec{e_1} \Vert} \\
                    \mat{H_1} & = \mat{I} - 2 \vec{u}\vec{u}^\top \\
                    \mat{H_1}\mat{A} & = \mat{H_1} [\vec{a_1}, \dots, \vec{a_n}] \\
                    & = [\mat{H_1}\vec{a_1}, \dots, \mat{H_1}\vec{a_n}] \\
                    & = \begin{bmatrix}
                        \Vert \vec{a_1} \Vert & \times \\
                        \vec{0} & \mat{A_2}
        ...
        \subsection*{13th February 2020}
            ...
            \subsubsection*{Condition}
                ...
                $$\kappa(P) = \max_{d_1, d_2} \frac{\Vert s(d_1) - s(d_2) \Vert}{\Vert d_1 - d_2 \Vert}$$
            ...
            \subsubsection*{Recap on Norms}
                ...
                $$\Vert \mat{A} \Vert = \max \left\{ \frac{\Vert \mat{A}\vec{x} \Vert}{\Vert \vec{x} \Vert} : \vec{x} \neq \vec{0} \right\} = \max \{\Vert \mat{A}\vec{u} \Vert : \Vert \vec{u} \Vert = 1\}$$
                This means that we have a lower bound of the matrix norm;
                $$\forall \vec{x} \neq \vec{0}\ \left[\Vert \mat{A} \Vert \geq \frac{\Vert \mat{A}\vec{x} \Vert}{\Vert \vec{x} \Vert}\right]$$
                A brief recap on the terms;
                \begin{itemize}
                    \itemsep0em
                    \item consistent norm \hfill $\Vert \mat{A}\vec{x} \Vert \leq \Vert \mat{A} \Vert \Vert \vec{x} \Vert$
            ...
            \subsubsection*{Perturbation}
                ...
                \begin{align*}
                    ...
                    \Vert \delta\vec{x_b} \Vert & \leq \Vert \mat{A}^{-1} \Vert \Vert \delta\vec{b} \Vert & \text{looking at \% increase}, \Rightarrow \\
                    \frac{\Vert \delta\vec{x_b} \Vert}{\Vert \vec{x} \Vert} & \leq \frac{\Vert \mat{A}^{-1} \Vert \Vert \delta\vec{b} \Vert}{\Vert \vec{x} \Vert} & (1)
                    \intertext{we now briefly look at $\mat{A}\vec{x} = \vec{b}$}
                    \mat{A}\vec{x} & = \vec{b} & \Rightarrow \\
                    \Vert \vec{b} \Vert & \leq \Vert \mat{A} \Vert \Vert \vec{x} \Vert & \Rightarrow \\
                    \Vert \vec{x} \Vert & \geq \frac{\Vert \vec{b} \Vert}{\Vert \mat{A} \Vert}
                    \intertext{we can replace the $\Vert \vec{x} \Vert$ in the RHS of (1) with something smaller, as it won't affect the inequality}
                    \frac{\Vert \delta\vec{x_b} \Vert}{\Vert \vec{x} \Vert} & \leq \frac{\Vert \mat{A}^{-1} \Vert \Vert \delta\vec{b} \Vert \Vert \mat{A} \Vert}{\Vert \vec{b} \Vert} & \Rightarrow \\
                    \frac{\Vert \delta\vec{x_b} \Vert}{\Vert \vec{x} \Vert} & \leq \Vert \mat{A}^{-1} \Vert \Vert \mat{A} \Vert \frac{\Vert \delta\vec{b} \Vert}{\Vert \vec{b} \Vert}
                \end{align*}
            \subsubsection*{Condition Number}
                ...
                \begin{align*}
                    ...
                    \Vert \delta\vec{x_A} \Vert & \leq \Vert \mat{A}^{-1} \Vert \Vert \delta\mat{A} \Vert \Vert \vec{x} \Vert & \Rightarrow \\
                    \frac{\Vert \delta\vec{x_A} \Vert}{\Vert \vec{x} \Vert} & \leq \Vert \mat{A}^{-1} \Vert \Vert \delta\mat{A} \Vert & \text{we want relative change}, \Rightarrow \\
                    \frac{\Vert \delta\vec{x_A} \Vert}{\Vert \vec{x} \Vert} & \leq \Vert \mat{A}^{-1} \Vert \Vert \mat{A} \Vert \frac{\Vert \delta\mat{A} \Vert}{\Vert \mat{A} \Vert}
                \end{align*}
                As such, we can define the condition of a matrix $\mat{A}$ as follows;
                \begin{center}
                    $\text{cond}(\mat{A}) = \Vert \mat{A}^{-1} \Vert \Vert \mat{A} \Vert$
                \end{center}
                This gives us the following useful property, allowing the condition to be an upper bound on the worst case;
                $$\text{cond}(\mat{A}) \geq \max \left\{ \frac{\frac{\Vert \delta\vec{x_b} \Vert}{\Vert \vec{x} \Vert} }{\frac{\Vert \delta\vec{b} \Vert}{\Vert \vec{b} \Vert} }, \frac{\frac{\Vert \delta\vec{x_A} \Vert}{\Vert \vec{x} \Vert}}{\frac{\Vert \delta\mat{A} \Vert}{\Vert \mat{A} \Vert}}\right\}$$
        ...
        \subsection*{19th February 2020}
            \subsubsection*{Revised Matrix Norm Terminology}
                \begin{itemize}
                    \itemsep0em
                    \item a matrix norm $\Vert \cdot \Vert_{\alpha, \beta}$ is \textbf{consistent} relative to vector-norms $\alpha$ on $\mathbb{R}^m$ and $\beta$ on $\mathbb{R}^n$ if
                        \begin{center}
                            $\forall \mat{A} \in \mathbb{R}^{m \times n}, \vec{x} \in \mathbb{R}^n\ [\Vert \mat{A}\vec{x} \Vert_\alpha \leq \Vert \mat{A} \Vert_{\alpha, \beta} \Vert \vec{x} \Vert_\beta]$
                        \end{center}
                    \item any induced / subordinate matrix norm is also sub-multiplicative because;
                        \begin{center}
                            $\Vert \mat{A}\mat{B} \Vert = \max \{ \Vert \mat{A}\mat{B}\vec{u} : \Vert \vec{u} \Vert = 1 \} \leq \max \{ \Vert \mat{A} \Vert \Vert \mat{B} \Vert \Vert \vec{u} \Vert : \Vert \vec{u} \Vert = 1 \} = \Vert \mat{A} \Vert \Vert \mat{B} \Vert$
                        \end{center}
                \end{itemize}
        ...
        \subsection*{20th February 2020}
            \subsubsection*{Proof of Convergence}
                We want to prove that for any consistent matrix norm, if $\Vert \mat{G} \Vert < 1$, then the iterative sequence converges for any starting $\vec{x^{(0)}}$.
                \medskip

                Suppose $\vec{x^{(k)}} \to \vec{\hat{x}}$, where $\vec{\hat{x}} = \mat{G}\vec{\hat{x}} + \vec{c}$.
                We want to define $\vec{y^{(k + 1)}}$ as follows;
                \begin{align*}
                    \vec{y^{(k + 1)}} & = \vec{x^{(k + 1)}} - \vec{\hat{x}} \\
                    & = \mat{G}\vec{x^{(k)}} + \vec{c} - (\mat{G}\vec{\hat{x}} + \vec{c}) \\
                    & = \mat{G}\vec{x^{(k)}} - \mat{G}\vec{\hat{x}} \\
                    & = \mat{G}(\vec{x^{(k)}} - \vec{\hat{x}}) \\
                    & = \mat{G}\vec{y^{(k)}} \\
                \end{align*}
                From this, we can use the property that $\mat{G}$ is consistent as follows;
                \begin{align*}
                    \Vert \vec{y^{(k + 1)}} \Vert & \leq \Vert \mat{G} \Vert \Vert \vec{y^{(k)}} \Vert \\
                    & \leq \Vert \mat{G} \Vert^2 \Vert \vec{y^{(k - 1)}} \Vert \\
                    & \leq \Vert \mat{G} \Vert^3 \Vert \vec{y^{(k - 2)}} \Vert \\
                    & \vdots \\
                    & \leq \Vert \mat{G} \Vert^{k + 1} \Vert \vec{y^{(0)}} \Vert
                \end{align*}
                However, we know that $\Vert \mat{G} \Vert^{k + 1} \Vert \vec{y^{(0)}} \Vert \to 0$ when $k \to \infty$, as $\Vert \mat{G} \Vert < 1$.
                Therefore, $\vec{y^{(k + 1)}} \to \vec{0}$ by the property of norms, hence $\vec{x^{(k + 1)}} \to \vec{\hat{x}}$
            % \subsubsection*{Choosing an Appropriate $\mat{G}$}
                % Let the rate of convergence of $\mat{G}$ be denoted $r(\mat{G}) \propto -\log_{10} \Vert \mat{G} \Vert$.
            \subsubsection*{Common Split}
                Assume, without loss of generality, that $\mat{A}$ has no zeroes on the diagonal.
                If it does, we can relabel the variables $x_i$ to permute the rows and columns to have no zeroes on the diagonal.
                \medskip

                We then define the following;
                $$\mat{A} = \mat{D} + \mat{L} + \mat{U}$$
                where $\mat{D}$ is the diagonal component, $\mat{L}$ is the \textbf{strict} lower triangular component (hence without the diagonal), and similar for $\mat{U}$.
            \subsubsection*{Jacobi Method}
                In the Jacobi method, we set the matrices (and vector) as follows;
                \begin{align*}
                    \mat{M} & = \mat{D} \\
                    \mat{N} & = \mat{L} + \mat{U} \\
                    \mat{G} & = -\mat{D}^{-1}(\mat{L} + \mat{U}) \\
                    \vec{c} & = \mat{D}^{-1}\vec{b} \\
                    \text{therefore } \vec{x^{(k + 1)}} & = \mat{G}\vec{x^{(k)}} + \vec{c} & \text{yields} \\
                    x_i^{(k + 1)} & = \frac{1}{a_{i, i}} \left(b_i - \summation{j \neq i}{} a_{j, j} x_j^{(k)}\right)
                \end{align*}
            ...
            \subsubsection*{Gauss-Seidel Method}
                \begin{align*}
                    \mat{M} & = \mat{D} + \mat{L} \\
                    \mat{N} & = \mat{U} \\
                    \mat{G} & = -(\mat{D} + \mat{L})^{-1}\mat{U} \\
                    \vec{c} & = (\mat{D} + \mat{L})^{-1}\vec{b} \\
                    \text{therefore } \vec{x^{(k + 1)}} & = \mat{G}\vec{x^{(k)}} + \vec{c} & \text{yields} \\
                    x_i^{(k + 1)} & = \frac{1}{a_{i, i}} \left(b_i - \summation{j = 1}{i - 1} a_{i, j} x_j^{(k + 1)} - \summation{j = i + 1}{m} a_{i, j} x_j^{(k)}\right)
                \end{align*}
                This gives faster convergence as we're able to use more up-to-date data.
                Working from the first column, we get;
                \begin{align*}
                    x_1^{(k + 1)} & = \frac{1}{a_{1, 1}} \left(b_1 - \summation{j = 2}{m} a_{1, j} x_j^{(k)}\right) \\
                    x_2^{(k + 1)} & = \frac{1}{a_{2, 2}} \left(b_2 - a_{2, 1} x_1^{(k + 1)} - \summation{j = 3}{m} a_{2, j} x_j^{(k)}\right) & \text{using the previous result} \\
                    & \vdots
                \end{align*}
            ...
            \subsubsection*{Convergence Conditions}
                We define a square matrix $\mat{A}$ as \textbf{strictly} row diagonally dominant for the $i^\text{th}$ row if
                $$| a_{i, i} | > \summation{j \neq i}{} | a_{i, j} |$$
                This means that the sum of the moduli of the all the elements on the row (except the diagonal element) is less than the modulus of the diagonal element.
                The theorem is that this is a sufficient condition for both Jacobi and Gauss-Seidel to converge.
                Below, we will do the proof for Jacobi;
                \begin{enumerate}[(1)]
                    \itemsep0em
                    \item show $\Vert \mat{G} \Vert < 1$, where $\mat{G} = -\mat{D}^{-1}\mat{N}$, using the consistent $\ell_\infty$-norm
                    \item strict diagonal dominance implies all absolute row sums are less than 1
                    \item the maximum absolute row sum is less than 1, therefore so is $\Vert \mat{G} \Vert_\infty$
                    \item any norm less than 1 leads to convergence
                \end{enumerate}
                \begin{align*}
                    \mat{G} & = -\mat{D}^{-1}\mat{N} \\
                    & = -\begin{bmatrix}
                        0 & \times & \times & \times & \times & \times & \times \\
                        \times & \ddots & \times & \times & \times & \times & \times \\
                        \times & \times & \ddots & \times & \times & \times & \times \\
                        \frac{a_{i, 1}}{a_{i, i}} & \cdots & \frac{a_{i, i - 1}}{a_{i, i}} & 0 & \frac{a_{i, i + 1}}{a_{i, i}} & \cdots & \frac{a_{i, m}}{a_{i, i}} \\
                        \times & \times & \times & \times & \ddots & \times & \times \\
                        \times & \times & \times & \times & \times & \ddots & \times \\
                        \times & \times & \times & \times & \times & \times & 0
                    \end{bmatrix} \\
                    \summation{j \neq i}{} | a_{i, j} | & < | a_{i, i} | & \text{by row diagonal dominance}, &\Rightarrow \\
                    \frac{1}{| a_{i, i} |} \summation{j \neq i}{} | a_{i, j} | & < 1
                \end{align*}
                Since we have an arbitrary row $i$, this holds for any row, hence the $\ell_\infty$-norm is less than 1 ($\Vert \mat{G} \Vert < 1$).
            \subsubsection*{Computation of Eigenvalues and Eigenvectors + Power Method}
                Computing the solutions of the characteristic polynomial is expensive.
                It takes $\Theta(n^3)$ to compute a single eigenvector of $\mat{A} \in \mathbb{R}^{n \times n}$ with Gaussian elimination.
                Therefore, it takes $\Theta(n^4)$ to compute all eigenvectors.
                \medskip

                One technique used is the power method, which can be applied to find other eigenvectors.
                However, by itself, it converges to an eigenvector of the dominant eigenvalue.
                Assume the matrix $\mat{A}$ has a unique dominant eigenvalue (which has the maximum modulus), and a corresponding unique eigenvector.
                Take a starting vector $\vec{x^{(0)}}$, we can define the recurrence for $k = 0, 1, 2, \dots$ as;
                $$\vec{x^{(k + 1)}} = \frac{\mat{A}\vec{x^{(k)}}}{\Vert \mat{A}\vec{x^{(k)}} \Vert}$$
                In general, the idea is to keep multiplying the current vector by $\mat{A}$ and normalising.
                The $\ell_2$-norm is useful as it is equal to the modulus of the dominant eigenvalue.
                \medskip

                The proposition is that for a diagonalisable matrix $\mat{M} \in \mathbb{R}^{n \times n}$, with distinct eigenvalues (moduli), the iteration converges to the eigenvector of $\mat{A}$.
                The absolute value of the dominant eigenvalue is the limit of the normalisation constant;
                $$\limit{k}{\infty} \Vert \mat{A}\vec{x^{(k)}} \Vert$$
                The proof is as follows;
                \medskip

                Let $(\vec{e_1}, \dots, \vec{e_n})$, consisting of the unit-eigenvectors of $\mat{A}$ form a basis of $\mathbb{R}^n$.
                We know we can do this as $\mat{A}$ is diagonalisable.
                Therefore, for an arbitrary $\vec{x^{(0)}} \in \mathbb{R}^n$;
                $$\vec{x^{(0)}} = \summation{i = 1}{n} \alpha_i \vec{e_i}$$
                For $k \geq 1$;
                \begin{align*}
                    \vec{x^{(k)}} & = \frac{\mat{A}\vec{x^{(k - 1)}}}{\Vert \mat{A}\vec{x^{(k - 1)}} \Vert} & \text{by recurrence relation} \\
                    & = \frac{\mat{A}^k\vec{x^{(0)}}}{\Vert \mat{A}^k\vec{x^{(0)}} \Vert} \\
                    & = \frac{\summation{i = 1}{n} \alpha_i \lambda_i^k \vec{e_i}}{\Vert \mat{A}^k\vec{x^{(0)}} \Vert} & \text{scale by an eigenvalue of eigenvector} \\
                    & = \frac{\lambda_1^k}{\Vert \mat{A}^k\vec{x^{(0)}} \Vert} \summation{i = 1}{n} \alpha_i \frac{\lambda_i}{\lambda_1}^k \vec{e_i} \\
                    & = \frac{\lambda_1^k}{\Vert \mat{A}^k\vec{x^{(0)}} \Vert} \left(\alpha_1 \vec{e_1} + \summation{i = 2}{n} \alpha_i \frac{\lambda_i}{\lambda_1}^k \vec{e_i}\right) \\
                    \limit{k}{\infty} \frac{\lambda_i}{\lambda_1}^k & = 0 & \text{for } i \neq 1, | \lambda_i | < | \lambda_1 | \\
                    \limit{k}{\infty} \vec{x^{(k)}} & = \frac{\lambda_1^k}{\Vert \mat{A}^k\vec{x^{(0)}} \Vert} \alpha_1 \vec{e_1} & \text{therefore } \vec{x^{(0)}} \to \vec{e_1}
                \end{align*}
                Using this result, we can conclude the following;
                $$\limit{k}{\infty} \Vert \mat{A}\vec{x^{(k)}} \Vert = \Vert \mat{A}\vec{e_1} \Vert = \Vert \lambda_1 \vec{e_1} \Vert = | \lambda_1 |$$
                \medskip

                The limitations of this method are the following;
                \begin{itemize}
                    \itemsep0em
                    \item starting vector $\vec{x^{(0)}}$ may have no component in the dominant eigenvector, such that $\vec{e_1}^\top \vec{x^{(0)}} = 0$, which leads to $\alpha_1 = 0$
                    \item may have multiple eigenvalues with maximum modulus, iteration then converges to a linear combination of those eigenvectors
                    \item convergence can be slow, if for example $\lambda_2$ is close to $\lambda_1$
                \end{itemize}
                Note that if the eigenvalues for the matrix $\mat{A}$ are $\lambda_1, \lambda_2, \dots$, then the eigenvalues for the matrix $\mat{A} - \sigma\mat{I}$ are $\lambda_1 - \sigma, \lambda_2 - \sigma, \dots$, with the same eigenvectors.
            \subsubsection*{Inverse Iteration}
                \begin{center}
                    $\mat{A}\vec{x} = \lambda\vec{x} \Rightarrow \vec{x} = \lambda\mat{A}^{-1}\vec{x} \Rightarrow \mat{A}^{-1}\vec{x} = \frac{1}{\lambda}\vec{x}$
                \end{center}
                This means that a matrix $\mat{A}^{-1}$, has eigenvalues $\frac{1}{\lambda_i}$, with the same corresponding eigenvectors as $\mat{A}$.
                Therefore the power iteration yields the reciprocal of the smallest eigenvalue of $\mat{A}$. An algorithm for the inverse iteration is done by a recurrence relation on pairs $(\vec{x^{(k)}}, \vec{y^{(k)}})$ for $k \geq 1$;
                \begin{align*}
                    \mat{A}\vec{y^{(k + 1)}} & = \vec{x^{(k)}} \\
                    \vec{x^{(k + 1)}} & = \frac{\vec{y^{(k + 1)}}}{\Vert \vec{y^{(k + 1)}} \Vert} & \left(= \frac{\mat{A}^{-1}\vec{x^{(k)}}}{\Vert \mat{A}^{-1}\vec{x^{(k)}} \Vert}\right)
                \end{align*}
                Since computing the inverse of $\mat{A}$ is expensive, the above can be used.
                We only need to solve for $\mat{A}\vec{y^{(k + 1)}} = \vec{x^{(k)}}$ with any method at each iteration.
                \medskip
            ...
            \subsubsection*{Rayleigh Quotient}
                Imagine we are at a point where we have an approximated eigenvector, let it be $\vec{z}$, with an approximated eigenvalue $\lambda$.
                Then, for $1 \leq i \leq n$, we have;
                $$\summation{j = 1}{n} a_{i, j} z_j = \lambda z_i$$
                Therefore, we can see this as a least squares problem of dimension $n \times 1$;
                $$\underbrace{\vec{z}}_{n \times 1} \underbrace{\lambda}_{1 \times 1} = \underbrace{\mat{A}}_{n \times n} \underbrace{\vec{z}}_{n \times 1}$$
                The normal equation is now $\vec{z}^\top\vec{z}\lambda = \vec{z}^\top\mat{A}\vec{z}$.
                Using this, we can then get the Rayleigh Quotient, which is the approximate solution;
                $$\hat{\lambda} \approx \frac{\vec{z}^\top\mat{A}\vec{z}}{\vec{z}^\top\vec{z}}$$
                From here, we can then choose $\sigma = \hat{\lambda}$, and shift it again.
                Ideally, $\sigma$ will now be extremely close to the actual value, hence the shifted eigenvalue will be very small, causing the reciprocal to be very large.
                While $\sigma$ changes each iteration, the eigenvectors don't.
            \subsubsection*{Second-Dominant Eigenvalue}
                Deflation is a term for transforming a matrix $\mat{A} \in \mathbb{R}^{n \times n}$ to a matrix $\mat{B} \in \mathbb{R}^{(n - 1) \times (n - 1)}$, with the largest (absolute) eigenvalue absent.
                We define a non-singular $\mat{H}$ as such, where $\vec{x_1}$ is the eigenvector of $\mat{A}$ with the largest absolute eigenvalue, $\alpha$ is some scalar constant, and $\vec{e_1}$ is the first standard basis vector;
                \begin{align*}
                    \violet{\mat{H}\vec{x_1}} & = \violet{\alpha\vec{e_1}} & \Rightarrow \\
                    \vec{x_1} & = \alpha\mat{H}^{-1}\vec{e_1} & \Rightarrow \\
                    \blue{\mat{H}^{-1}\vec{e_1}} & = \blue{\frac{\vec{x_1}}{\alpha}} \\
                    \red{\mat{A}\vec{x_1}} & = \red{\lambda_1 \vec{x_1}} & \text{we know $\vec{x_1}$ is an eigenvector} \\
                    \mat{H}\mat{A}\blue{\mat{H}^{-1}\vec{e_1}} & = \frac{1}{\alpha}\mat{H}\red{\mat{A}\vec{x_1}} \\
                    & = \frac{\lambda_1}{\alpha}\violet{\mat{H}\vec{x_1}} \\
                    & = \lambda_1 \vec{e_1} \\
                    & = (\mat{H}\mat{A}\mat{H}^{-1})_1 & \text{first column} \\
                    & = \begin{bmatrix}
                        \lambda_1 & \vec{b}^\top \\
                        \vec{0} & \mat{B}
                    \end{bmatrix} & \text{where } \vec{0}, \vec{b} \in \mathbb{R}^{n - 1}, \mat{B} \in \mathbb{R}^{(n - 1) \times (n - 1)}
                \end{align*}
                To show they have the same eigenvalues, we do the following;
                $$\mat{A}\vec{x} = \lambda \vec{x} \Leftrightarrow \mat{H}\mat{A}\vec{x} = \lambda\mat{H}\vec{x} \Leftrightarrow \mat{H}\mat{A}\mat{H}^{-1}(\mat{H}\vec{x}) = \lambda\mat{H}\vec{x}$$
                Therefore, $\mat{A}$ and $\mat{H}\mat{A}\mat{H}^{-1}$ have the same eigenvalues, but $\mat{H}\mat{A}\mat{H}^{-1}$ has eigenvectors $\vec{y_i} = \mat{H}\vec{x_i}$.
                Therefore $\mat{B}$ has eigenvectors $\lambda_2, \dots, \lambda_n$.
                \medskip

                We want to prove that the eigenvector corresponding to $\lambda_2$, for a given $\mat{H}$, is
                \begin{align*}
                    \vec{x_2} & = \mat{H}^{-1} \begin{bmatrix}
                        \beta \\ \vec{z_2}
                    \end{bmatrix} & \text{where $\vec{z_2}$ is a dominant eigenvector of $\mat{B}$} \\
                    \beta & = \frac{\vec{b}^\top\vec{z_2}}{\lambda_2 - \lambda_1}
                \end{align*}
                To verify this, we do the following;
                \begin{align*}
                    \vec{x_2} & = \mat{H}^{-1}\vec{y} & \text{$\vec{y}$ is an eigenvector of $\mat{H}\mat{A}\mat{H}^{-1}$ with eigenvalue $\lambda_2$} \\
                    \text{let } \vec{y} & = \begin{bmatrix}
                        y_1 \\ \vec{z}
                    \end{bmatrix} \\
                    \mat{H}\mat{A}\mat{H}^{-1} & = \begin{bmatrix}
                        \lambda_1 & \vec{b}^\top \\
                        \vec{0} & \mat{B}
                    \end{bmatrix} \\
                    \begin{bmatrix}
                    ...
                    \lambda_2 y_1 & = \lambda_1 y_1 + \vec{b}^\top\vec{z} & \Rightarrow \\
                    y_1 & = \frac{\vec{b}^\top\vec{z}}{\lambda_2 - \lambda_1} \\
                    \lambda_2 \vec{z} & = \vec{0}y_1 + \mat{B}\vec{z} \\
                    & = \mat{B} \vec{z} & \Rightarrow \\
                    \beta & = y_2 \\
                    \vec{z_2} & = \vec{z}
                \end{align*}
            \subsubsection*{Householder}
                One of the available choices for $\mat{H}$ is the Householder transformation, which represents a reflection in the plane with a normal vector of $\vec{u}$.
                $$\mat{H} = \mat{I} - \frac{2\vec{u}\vec{u}^\top}{\vec{u}^\top\vec{u}}$$
                For this part, we define $\vec{u} = \vec{v} \pm \Vert \vec{v} \Vert_2 \vec{e_1}$, for a vector $\vec{v} = \vec{x_1}$.
                Then we have $\mat{H}\vec{v} = \mp \Vert \vec{v} \Vert \vec{e_1}$, so we find $\alpha = \mp \Vert \vec{x_1} \Vert$.
                This result is proved as follows;
                \begin{align*}
                    v_1 & = \vec{v}^\top\vec{e_1} \\
                    \vec{u}^\top\vec{u} & = 2 \Vert \vec{v} \Vert (\Vert \vec{v} \Vert \pm v_1) \\
                    \vec{u}^\top\vec{v} & = \vec{v}^\top\vec{u} \\
                    & = \Vert \vec{v} \Vert (\Vert \vec{v} \Vert \pm v_1) \\
                    \mat{H} & = \mat{I} - \frac{2\vec{u}\vec{u}^\top}{\vec{u}^\top\vec{u}} & \Rightarrow \\
                    \mat{H}\vec{v} & = \vec{v} - \frac{2\vec{u}(\vec{u}^\top\vec{v})}{\vec{u}^\top\vec{u}} \\
                    & = \vec{v} - \vec{u} \\
                    & = \mp \Vert \vec{v} \Vert_2 \vec{e_1} & \blacksquare
                \end{align*}
        \subsection*{26th February 2020}
            \subsubsection*{QR Algorithm}
                Note that for an upper triangular matrix
                $$\mat{U} = \begin{bmatrix}
                    u_{1, 1} & \times & \times & \times \\
                    & u_{2, 2} & \times & \times \\
                    & & \ddots & \times \\
                    & & & u_{n, n}
                \end{bmatrix}$$
                The characteristic polynomial is
                $$| \mat{U} - \lambda\mat{I} | = \product{i = 1}{n} (u_{i, i} - \lambda)$$
                Meaning that the eigenvalues are $u_{1, 1}, u_{2, 2}, \dots, u_{n, n}$, which is the diagonal of the matrix.
                \medskip

                Also note that a matrix $\mat{A}$ is similar to $\mat{B}$ if $\mat{B} = \mat{P}^{-1}\mat{A}\mat{P}$.
                This is an equivalence relation, and it also preserves the characteristic polynomial, hence has the same eigenvalues.
                \medskip

                The general idea of the QR algorithm is that it generates a sequence of similar matrices $\mat{A^{(0)}}, \mat{A^{(1)}}, \dots$ which approaches an upper triangular matrix.
                The diagonal of this upper triangular matrix will then give the eigenvalues of $\mat{A}$.
                It follows this general sequence of steps;
                \begin{enumerate}[(1)]
                    \itemsep0em
                    \item starting with the standard basis, set $\mat{A^{(0)}} = \mat{A} (= \mat{Q}\mat{R} = \mat{Q^{(1)}}\mat{R^{(1)}})$
                    \item apply QR decomposition with any method to compute $\mat{A^{(m)}} = \mat{Q^{(m + 1)}}\mat{R^{(m + 1)}}$, where $\mat{Q^{(m + 1)}}$ is orthogonal, and $\mat{R^{(m + 1)}}$ is upper triangular
                    \item define $\mat{A^{(m + 1)}} = \mat{R^{(m + 1)}}\mat{Q^{(m + 1)}} = \mat{Q^{(m + 1)}}^\top\mat{A^{(m)}}\mat{Q^{(m + 1)}}$
                        \subitem note that because $\mat{Q^{(m + 1)}}$ is orthogonal (actually orthonormal), $\mat{Q^{(m + 1)}}^\top = \mat{Q^{(m + 1)}}^{-1}$, $\mat{A^{(m + 1)}}$ must be similar to $\mat{A^{(m)}}$
                    \item halt after sufficient iterations
                \end{enumerate}
                We claim that $\mat{A^{(m)}} \to \mat{U}$, where $\mat{U}$ is an upper triangular matrix, as $m \to \infty$.
                $$\mat{A^{(m)}} = \mat{Q^{(m)}}^\top\mat{Q^{(m - 1)}}^\top \cdots \mat{Q^{(1)}}^\top\mat{A^{(0)}}\underbrace{\mat{Q^{(1)}}\mat{Q^{(2)}} \cdots \mat{Q^{(m)}}}_{\mat{\tilde{Q}^{(m)}}} = \mat{\tilde{Q}^{(m)}}^\top\mat{A}\mat{\tilde{Q}^{(m)}}$$
                Note that $\mat{\tilde{Q}^{(m)}}$ is orthogonal, as it is the product of orthogonal matrices, hence $\mat{A^{(m)}}$ must be similar to $\mat{A}$, therefore $\mat{A^{(m)}}$ has the same eigenvalues as $\mat{A}$.
                The eigenvectors of $\mat{A}$ are;
                $$\left\{\mat{\tilde{Q}^{(m)}}^\top \vec{w} : \vec{w} \text{ is an eigenvector of } \mat{A^{(m)}} \right\}$$

                It is easy to compute the eigenvectors of a upper triangular matrix, which we approach, with backwards substitution.
                Note that it can be quicker to use the inverted shift with an approximation of the eigenvalue.
                \medskip

                Note that for any symmetric matrix $\mat{A}$, $\mat{A^{(m)}}$ must also be symmetric.
                Therefore, if $\mat{A^{(m)}}$ approaches an upper triangular matrix, it must approach $\mat{\Lambda}$, which is a diagonal vector of the eigenvalues of $\mat{A}$;
                $$\mat{\Lambda} = \begin{bmatrix}
                    u_{1, 1} & \violet{0} & \violet{\cdots} & \violet{0} \\
                    0 & u_{2, 2} & \violet{\ddots} & \violet{\vdots} \\
                    \vdots & \ddots & \ddots & \violet{0} \\
                    0 & \cdots & 0 & u_{n, n}
                \end{bmatrix}$$
                Due to this, $\mat{\tilde{Q}^{(m)}}$ approaches the matrix of eigenvectors of $\mat{A}$.
            \subsubsection*{LU Decomposition}
                We can write any non-singular matrix $\mat{M} = \mat{L}\mat{U}$.
                This is because we can reduce $\mat{M}$ to row echelon form (which is upper triangular), with the products of lower triangular matrices.
                Also note that a unit triangular matrix has all 1s on the diagonal.
                In this proof, we can also use the fact
                $$\mat{A}^n = \mat{Q^{(1)}} \cdots \mat{Q^{(n)}} \mat{R^{(n)}} \cdots \mat{R^{(1)}}$$
                We propose that $\mat{A^{(m)}} \to \mat{\Lambda}$, as $m \to \infty$, for a symmetric matrix $\mat{A} \in \mathbb{R}^{n \times n}$, with distinct eigenvalues $\lambda_1 > \lambda_2 > \dots > \lambda_n > 0$.
                Also let $\mat{A} = \mat{Q}\mat{\Lambda}\mat{Q}^\top$ be the eigenvalue decomposition (same as spectral decomposition), and $\mat{Q}^\top = \mat{L}\mat{U}$ with a \textbf{unit} lower triangular $\mat{L}$, and an upper triangular $\mat{U}$.
                The proof is as follows;
                \begin{align*}
                    \mat{A}^n & = \mat{Q}\mat{\Lambda}\mat{Q}^\top \\
                    & = \mat{Q^{(1)}} \cdots \mat{Q^{(n)}} \mat{R^{(n)}} \cdots \mat{R^{(1)}} & \Rightarrow \\
                    \mat{Q}\mat{\Lambda}\mat{L}\mat{U} & = \mat{Q^{(1)}} \cdots \mat{Q^{(n)}} \mat{R^{(n)}} \cdots \mat{R^{(1)}} & \Rightarrow \\
                    \mat{Q}\mat{\Lambda}\mat{L} & = \mat{Q^{(1)}} \cdots \mat{Q^{(n)}} \mat{R^{(n)}} \cdots \mat{R^{(1)}}\mat{U}^{-1} & \Rightarrow \\
                    \mat{Q}\mat{\Lambda}\mat{L}\mat{\Lambda}^{-n} & = \mat{Q^{(1)}} \cdots \mat{Q^{(n)}} \mat{R^{(n)}} \cdots \mat{R^{(1)}}\mat{U}^{-1}\mat{\Lambda}^{-n} \\
                    (\mat{\Lambda}\mat{L}\mat{\Lambda}^{-n})_{i, j} & = \begin{cases}
                        \ell_{i, j} \frac{\lambda_i}{\lambda_j}^n & i > j \\
                        1 & i = j \\
                        0 & i < j
                    \end{cases} & \Rightarrow \\
                    \limit{n}{\infty} \mat{\Lambda}\mat{L}\mat{\Lambda}^{-n} & = \mat{I}
                \end{align*}
                Therefore, $\mat{Q^{(1)}} \cdots \mat{Q^{(n)}} \mat{R^{(n)}} \cdots \mat{R^{(1)}}\mat{U}^{-1}\mat{\Lambda}^{-n} \to \mat{Q}$.
                Because the QR decomposition is unique, $\mat{\tilde{Q}^{(n)}} = \mat{Q^{(1)}} \cdots \mat{Q^{(n)}} \to \mat{Q}$, and $\mat{R^{(n)}} \cdots \mat{R^{(1)}}\mat{U}^{-1}\mat{\Lambda}^{-n} \to \mat{I}$, meaning $\mat{R^{(n)}} \cdots \mat{R^{(1)}} \to \mat{\Lambda}^{n}\mat{U}$.
                Note that for $\mat{\tilde{Q}^{(n)}}$ to tend to a constant matrix, $\mat{Q^{(n)}} \to \mat{I}$.
                From the second limit, we can argue that $\mat{R^{(n)}} \to \mat{\Lambda}$, as $\mat{\Lambda}$ is applied $n$ times.
                Finally, we defined $\mat{A^{(m)}} = \mat{R^{(m)}}\mat{Q^{(m)}}$, so
                $$\limit{m}{\infty}\mat{A^{(m)}} = \mat{\Lambda}$$.
                We also have $\mat{\tilde{Q}^{(m)}} \to \mat{Q}$ which diagonalises $\mat{A}$, and therefore must be the matrix of eigenvectors.
        \subsection*{27th February 2020}
            \subsubsection*{Laplace Transform}
                The Laplace transform is a special case of the Fourier transform.
                The Laplace transform of a function $f(t)$, defined for real $t \geq 0$, is denoted $F(s) = (\laplace f)$;
                $$F(s) = (\laplace f)(s) = \defint{0}{\infty}{e^{-st}f(t)}{t}$$
                Generally, $s \in \mathbb{C} = \sigma + i\omega$, therefore the Laplace transform has the "type signature" $\laplace : (\mathbb{R}^+ \to \mathbb{R}^+) \to (\mathbb{C} \to \mathbb{C})$.
                However, in this course we normally use positive reals, hence we have an output of $(\mathbb{R}^+ \to \mathbb{R}^+)$.
                Some common examples are the following;
                \begin{itemize}
                    \itemsep0em
                    \item unit function (strictly Heaviside function, but we only consider $t \geq 0$)
                        \begin{align*}
                            H(t) & = \begin{cases}
                                1 & t \geq 0 \\
                                0 & t < 0
                            \end{cases} \\
                            f(t) & = 1 \\
                            F(s) & = \defint{0}{\infty}{f(t)e^{-st}}{t} \\
                            & = \defint{0}{\infty}{e^{-st}}{t} \\
                            & = -\frac{1}{s}\intbracket{0}{\infty}{e^{-st}} \\
                            & = -\frac{1}{s}(0 - 1) \\
                            & = \frac{1}{s}
                        \end{align*}
                    \item exponential function (general case of the above)
                        \begin{align*}
                            f(t) & = e^{-\lambda t} \\
                            F(s) & = \defint{0}{\infty}{e^{-\lambda t}e^{-st}}{t} \\
                            & = \defint{0}{\infty}{e^{-(\lambda + s)t}}{t} \\
                            & = -\frac{1}{\lambda + s}\intbracket{0}{\infty}{e^{-(\lambda + s)t}} \\
                            & = -\frac{1}{\lambda + s}(0 - 1) \\
                            & = \frac{1}{\lambda + s}
                        \end{align*}
                    \item identity function
                        \begin{align*}
                            f(t) & = t \\
                            F(s) & = \defint{0}{\infty}{t e^{-st}}{t} \\
                            & = \intbracket{0}{\infty}{\frac{e^{-st}}{-s} t} - \defint{0}{\infty}{\frac{e^{-st}}{-s} \cdot 1}{t} \\
                            & = 0 + \frac{1}{s} \defint{0}{\infty}{e^{-st}}{t} \\
                            & = \frac{1}{s^2}
                        \end{align*}
                    \item exponential function
                        \begin{align*}
                            f(t) & = t^n \\
                            F(s) & = \defint{0}{\infty}{t^n e^{-st}}{t} \\
                            & = \intbracket{0}{\infty}{\frac{e^{-st}}{-s} t^n} - \defint{0}{\infty}{n \frac{e^{-st}}{-s} t^{n - 1}}{t} \\
                            & = 0 + \frac{n}{s} \defint{0}{\infty}{e^{-st} t^{n - 1} }{t} \\
                            & = \frac{n}{s} \cdot \frac{n - 1}{s} \defint{0}{\infty}{e^{-st} t^{n - 2} }{t} \\
                            & \vdots \\
                            & = \frac{n!}{s^{n + 1}}
                        \end{align*}
                    \item non-negative real power
                        \begin{align*}
                            \Gamma(z) & = \defint{0}{\infty}{t^{z - 1}e^{-t}}{t} \\
                ...
                \begin{enumerate}[(1)]
                    \itemsep0em
                    \item $\laplace$ is a bijection (unique inverse), therefore if we recognise some $F$, we know that $f$ is
                    \item it is a linear operator, and therefore it is simple to compute for many useful functions
                    \item simple to get transform of the derivative of a function
                    \item moment generating function
                        \begin{itemize}
                            \itemsep0em
                            \item Laplace transform of a convolution is a product
                        \end{itemize}
                \end{enumerate}
                We can work out the derivative of a Laplace transform as such;
                \begin{align*}
                    F(s) & = \defint{0}{\infty}{e^{-st}f(t)}{t} \\
                    \dif{}{s} F(s) & = \defint{0}{\infty}{\left(\dif{}{s} e^{-st}\right)f(t)}{t} & \text{interchange of limiting operations} \\
                    & = \defint{0}{\infty}{-t e^{-st}f(t)}{t} \\
                    & = -\defint{0}{\infty}{(tf(t))e^{-st}}{t} \\
                    & = -(\laplace (t f(t)))(s) \\
                    & = -(\laplace (\lambda t.\ t f(t)))(s) & \text{strictly with $\lambda$-calculus}
                \end{align*}
            \subsubsection*{Laplace Transform of a Derivative}
                \begin{align*}
                    f^\prime(t) & = \dif{}{t}f(t) \\
                    (\laplace f^\prime)(s) & = \defint{0}{\infty}{e^{-st}f^\prime(t)}{t} \\
                    & = \intbracket{0}{\infty}{e^{-st}f(t)} - \defint{0}{\infty}{-s e^{-st}f(t)}{t} \\
                    & = -f(0) + s\defint{0}{\infty}{e^{-st}f(t)}{t} & \text{assuming sub-exponential convergence for $\limit{t}{\infty} f(t)$} \\
                    & = -f(0) + s(\laplace f)(s) \\
                    & = s(\laplace f)(s) - f(0)
                \end{align*}
                Commonly, $\dot{f}$ is used to denote $f$ differentiated with respect to $t$.
                It's important to remember the following;
                \begin{center}
                    $(\laplace f^\prime)(s) = (\laplace \dot{f})(s) = sF(s) - f(0)$
                \end{center}
                A example for the sub-exponential convergence, where it doesn't hold;
                \begin{align*}
                    f(t) & = e^{4t} \\
                    F(s) & = \defint{0}{\infty}{e^{-st}e^{4t}}{t} \\
                    & = \defint{0}{\infty}{e^{(4 - s)t}}{t}
                \end{align*}
                Note that $F \to \infty$ if $s \leq 4$.
            \subsubsection*{Application of Laplace Transforms to Differential Equations}
                Starting with a fairly simple example, which would've been encountered previously;
                \begin{align*}
                    \dif{y}{t} & = \dot{y} \\
                    & = \mu y \\
                    Y & = \laplace y
                    \intertext{taking Laplace transforms of both sides}
                    sY(s) - y(0) & = \mu Y(s) & \Rightarrow \\
                    (s - \mu)Y(s) & = y(0) & \Rightarrow \\
                    Y(s) & = \frac{y(0)}{s - \mu}
                    \intertext{note that this is similar to $f(t) = e^{-\lambda t}$, so by uniqueness, with $\lambda = -\mu$}
                    Y(s) & = y(0)e^{\mu t}
                \end{align*}
                ...
                \begin{align*}
                    ...
                    3\dot{y} & = 2x - 3z \\
                    \dot{z} & = -3y
                    \intertext{taking Laplace transforms of the equations, substituting initial values}
                    ...
                    3Y(s) + sZ(s) & = 0
                    \intertext{writing this in matrix form and solving with inverse}
                    \begin{bmatrix}
                        s & 0 & 1 \\
                        -\frac{2}{3} & s & 1 \\
                        0 & 3 & s
                    ...
                    \begin{bmatrix}
                        X \\ Y \\ Z
                    \end{bmatrix} & = \frac{1}{(s - 1)^2(s + 2)} \begin{bmatrix}
                        s^2 - 3 & -3 & s \\
                        \frac{2s}{3} & s^2 & - \frac{3s - 2}{3} \\
                        -2 & -3s & s^2
                    \end{bmatrix} \begin{bmatrix}
                        \frac{1}{s^2} \\ 0 \\ 0
                    \end{bmatrix} \\
                    & = \frac{1}{(s - 1)^2(s + 2)} \begin{bmatrix}
                        \frac{s^2 - 3}{s^2} \\
                        \frac{2}{3s} \\
                        -\frac{2}{s^2}
                    \end{bmatrix} \\
                    & = \begin{bmatrix}
                        -\frac{\frac{2}{3}}{(s - 1)^2} + \frac{\frac{20}{9}}{s - 1} + \frac{\frac{1}{36}}{s + 2} - \frac{\frac{3}{2}}{s^2} - \frac{\frac{9}{4}}{s} \\
                        \frac{\frac{2}{9}}{(s - 1)^2} - \frac{\frac{8}{27}}{s - 1} - \frac{\frac{1}{27}}{s + 2} + \frac{\frac{1}{3}}{s} \\
                        -\frac{\frac{2}{3}}{(s - 1)^2} + \frac{\frac{14}{9}}{s - 1} - \frac{\frac{1}{18}}{s + 2} - \frac{1}{s^2} - \frac{\frac{3}{2}}{s}
                    \end{bmatrix} \\
                    x(t) & = -\frac{2t e^t}{3} + \frac{20e^2}{9} + \frac{e^{-2t}}{36} - \frac{3t}{2} - \frac{9}{4} \\
                    y(t) & = \frac{2t e^t}{9} - \frac{8e^2}{27} + \frac{e^{-2t}}{27} - \frac{1}{3} \\
                    z(t) & = -\frac{2t e^t}{3} + \frac{14e^2}{9} + \frac{e^{-2t}}{18} - t - \frac{3}{2}
                \end{align*}
            \subsubsection*{Convolutions}
                The convolution of functions $f, g : \mathbb{R}^+ \to \mathbb{R}$ is denoted $f * g$, defined as;
                \begin{align*}
                    (f * g)(t) & = \defint{0}{t}{f(u)g(t - u)}{u} \\
                    & = \defint{0}{t}{f(t - u)g(u)}{u} \\
                    L(s) & = \laplace(f * g)(s) \\
                    & = \defint{t = 0}{t = \infty}{e^{-st}\left(\defint{u = 0}{u = \infty}{f(u)g(t - u)}{u}\right)}{t}
                    \intertext{we know $t - u > 0$, therefore $u < t$, where $u, t \in \mathbb{R}^+$, now change order of integration}
                    & =\defint{u = 0}{u = \infty}{\defint{t = u}{t = \infty}{e^{-st}f(u)g(t - u)}{u}}{t}
                    \intertext{change $t$ to $v = t - u$}
                    & =\defint{u = 0}{u = \infty}{\defint{v = 0}{v = \infty}{e^{-s(u + v)}f(u)g(v)}{u}}{v} \\
                    & =\defint{u = 0}{u = \infty}{e^{-su}f(u)}{u}\defint{v = 0}{v = \infty}{e^{-sv}g(v)}{v} \\
                    & = F(s)G(s)
                \end{align*}
            \subsubsection*{Inversion}
                Since we know that the Laplace transform has a unique inverse, we can often solve by inspection with the use of linearity.
                It can be solved with an inversion formula such as the Bromwich integral (not used in our course);
                $$f(t) = \frac{1}{2 \pi i} \defint{\gamma - i\infty}{\gamma - i\infty}{e^{st}F(s)}{s}$$
                Where $\gamma$ is a real greater than all the real parts of the singularities of $F(s)$ (where $F(s)$ goes to infinity).
                For example, a singularity of $F$ is $-\lambda$ when
                $$F(s) = \frac{1}{s + \lambda}$$
                This inversion formula comes from the Laplace transform being a special case of the Fourier transform.
            \subsubsection*{Dominant and Co-dominant Spaces}
                Suppose we have diagonalisable $\mat{M} \in \mathbb{C}^{n \times n}$, with distinct eigenvalues of moduli $| \lambda_1 | > | \lambda_2 | > \dots > | \lambda_n |$, with corresponding eigenvectors $\vec{v_1}, \vec{v_2}, \dots, \vec{v_n}$.
                Let the subspaces $T_k$ (dominant) and $U_k$ (co-dominant) be spanned by the bases $(\vec{v_1}, \dots, \vec{v_k})$ (first $k$ dominant eigenvectors) and $(\vec{v_{k + 1}}, \dots, \vec{v_n})$.
                They are both invariant under $\mat{A}$.
                \medskip

                Let $S$ be a $k$-dimensional subspace of $\mathbb{C}^n$ such that $S \cap U_k = \{ \vec{0} \}$.
                Then $\mat{A}^m S \to T_k$ as $m \to \infty$.
                In the case $k = 1$, we have the same result as the power-iteration.
                \medskip

                To prove this generally, we take a $\vec{v} \in S$, where $\vec{v} \neq \vec{0}$;
                $$\vec{v} = \summation{i = 1}{n} c_i\vec{v_i} = \underbrace{\summation{i = 1}{k} c_i\vec{v_i}}_{\in T_k} + \underbrace{\summation{i = k + 1}{n} c_i\vec{v_i}}_{\in U_k}$$
                Since we know $\vec{v} \neq \vec{0}$, there has to be at least one $c_i \neq 0$, for $1 \leq i \leq k$, otherwise it would be in $U_k$.
                Applying $\mat{A}$ $m$ times, we see the growth due to the eigenvalues as;
                $$\mat{A}^m\vec{v} = \summation{i = 1}{k} c_i\lambda_i^m\vec{v_i} + \summation{i = k + 1}{n} c_i\lambda_i^m\vec{v_i} \Rightarrow \frac{\mat{A}^m\vec{v}}{\lambda_k^m} = \summation{i = 1}{k} c_i\frac{\lambda_i}{\lambda_k}^m\vec{v_i} + \summation{i = k + 1}{n} c_i\frac{\lambda_i}{\lambda_k}^m\vec{v_i}$$
                However, since $\lambda_i < \lambda_k$ if $i > k$, the component in $U_k$ approaches $\vec{0}$, when $k \to \infty$.
                As proven, there exists at least one non-zero $c_i$ in the $T_k$ component, hence $\mat{A}^m\vec{v}$ approaches a vector in $T_k$.
                \medskip

                Let $\mat{Q} = [\mat{Q_1}, \mat{Q_2}]$, where $\mat{Q} \in \mathbb{C}^{n \times n}$ is formed by appending $\mat{Q_1} \in \mathbb{C}^{n \times k}$ and $\mat{Q_2} \in \mathbb{C}^{n \times (n - k)}$.
                Suppose the columns of $\mat{Q_1}$ form an orthonormal basis for $T_k$, and similar for $\mat{Q_2}$ for $U_k$, therefore all the columns form an orthonormal basis for $\mathbb{C}^n$.
                We propose the following;
                \begin{align*}
                    \mat{Q}^\top\mat{A}\mat{Q} & = \begin{bmatrix}
                        \mat{A_{1, 1}} & \mat{A_{1, 2}} \\
                        \mat{0} & \mat{A_{2, 2}}
                    \end{bmatrix} \\
                    \mat{A_{1, 1}} & = \mat{Q_1}^\top\mat{A}\mat{Q_1} & \in \mathbb{C}^{k \times k} \\
                    \mat{A_{1, 2}} & = \mat{Q_1}^\top\mat{A}\mat{Q_2} & \in \mathbb{C}^{k \times (n - k)} \\
                    \mat{A_{2, 2}} & = \mat{Q_1}^\top\mat{A}\mat{Q_2} & \in \mathbb{C}^{(n - k) \times (n - k)}
                \end{align*}
            \subsubsection*{Subspace Convergence}
                Let $\mat{P(m)} = [\mat{P_1}, \mat{P_2}]$, $\mat{P(m)} \in \mathbb{C}^{n \times n}$ is formed by appending $\mat{P_1} \in \mathbb{C}^{n \times k}$ and $\mat{P_2} \in \mathbb{C}^{n \times (n - k)}$.
                $\mat{P(m)}$ is a unitary matrix, which is an orthogonal matrix, but allows for complex numbers.
                The range of $\mat{P_1}$ is $\mat{A}^mS_k$
                We propose that $\mat{B_{2, 1}} \to \mat{0}$, as $m \to \infty$, in the following;
                $$\mat{P(m)}^\top\mat{A}\mat{P(m)} = \begin{bmatrix}
                    \mat{B_{1, 1}} & \mat{B_{1, 2}} \\
                    \mat{B_{2, 1}} & \mat{B_{2, 2}}
                \end{bmatrix}$$
                % \begin{itemize}
                %     \itemsep0em
                %     \item since $\mat{A}^mS \to T_k$ (already proven), the columns of $\mat{P_1}$ become close to vectors in $T_k$ as $m \to \infty$, similarly the columns of $\mat{P_2}$ become close to vectors in $U_k$
                % \end{itemize}
            \subsubsection*{Subspace Iteration}
                Take a subspace $S$, which has no null vectors of $\mat{A}$.
                Suppose $(\vec{q_1^{(0)}}, \dots, \vec{q_k^{(0)}})$ is an orthonormal basis of $S$.
                Then clearly $(\mat{A}^m\vec{q_1^{(0)}}, \dots, \mat{A}^m\vec{q_k^{(0)}})$ is a basis of $\mat{A}^mS$.
                However, with results proven earlier, all vectors with $\vec{v_1}$-components (the dominant eigenvector of $\mat{A}$) will tend to the dominant subspace $\la \vec{v_1} \ra$, as $m \to \infty$.
                These then start to point in the same direction, thus causing the matrix to become ill-conditioned.
                A solution to this is to orthonormalise at each iteration of the algorithm;
                \begin{itemize}
                    \itemsep0em
                    \item given $(\vec{q_1^{(m)}}, \dots, \vec{q_k^{(m)}})$ as a basis of $S$, calculate $\mat{A}\vec{q_1^{(m)}}, \dots, \mat{A}\vec{q_k^{(m)}}$
                    \item choose $(\vec{q_1^{(m + 1)}}, \dots, \vec{q_k^{(m + 1)}})$ as a basis of $\mat{A}^{m + 1}S$ by orthonormalising $\mat{A}\vec{q_1^{(m)}}, \dots, \mat{A}\vec{q_k^{(m)}}$ left to right, with something such as Gram-Schmidt.
                \end{itemize}
                This iteration holds for all subspace pairs.
            \subsubsection*{Triangulation Property}
                We aren't expected to remember this (I hope, since I didn't write most of it).
                This uses the proposition in the \textbf{Subspace Convergence} section above.
                Since this is true for all $k$ simultaneously, the limiting form is upper triangular.
        \subsection*{4th March 2020}
            \subsubsection*{Fourier Transforms}
                Laplace transforms are only defined for functions on the positive reals, as $e^{-st}$ gets very large when $t \to -\infty$, for $s > 0$.
                We denote the Fourier Transform of $f$ as $\tilde{f} = \fourier f$
                $$\tilde{f}(\omega) = \defint{-\infty}{\infty}{e^{-i\omega x}f(x)}{x}$$
                Which has the inverse transform
                $$f(x) = \frac{1}{2\pi} \defint{-\infty}{\infty}{e^{i\omega x}\tilde{f}(\omega)}{\omega}$$
            \subsubsection*{Dirac Delta Function}
                Also referred to as $\delta$-function, which is a generalised function (or distribution) that is "undefined" at 0, and 0 everywhere else.
                It has an integral of 1 across the entire real line, and one can consider there to be an infinite spike at the origin.
                $$\defint{-\infty}{\infty}{\delta(x)}{x} = 1$$
                The integral of a function multiplied by $\delta$-function is $f(0)$, as follows (not rigorous);
                \begin{align*}
                    \defint{-\infty}{\infty}{f(x)\delta(x)}{x} & = \defint{-\epsilon}{\epsilon}{f(x)\delta(x)}{x} & \forall \epsilon > 0 \\
                    & \approx f(0) \defint{-\epsilon}{\epsilon}{\delta(x)}{x} & \text{at small } \epsilon \\
                    & = f(0)
                \end{align*}
                ...
                Note that in the distribution $N(0, \sigma^2)$, we have $a = \sqrt{2\sigma}$.
                As the variance goes down towards 0, we get a "sharper" spike at the origin, which is one way we looked at the delta function;
                $$\delta(x) = \limit{a}{0} \frac{1}{a\sqrt{\pi}}e^{-\frac{x^2}{a^2}}$$
                We can define $a = \frac{1}{\sqrt{n}}$, and have the following as the limit of the delta-sequence ($\delta_n(x)$);
                $$\delta(x) = \limit{n}{\infty} \delta_n(x) = \limit{n}{\infty} \sqrt{\frac{n}{\pi}}e^{-nx^2}$$
                We can rigorously prove the following;
                $$\defint{-\infty}{\infty}{\delta(x - a)f(x)}{x} = \limit{n}{\infty} \defint{-\infty}{\infty}{\delta_n(x - a)f(x)}{x} = f(a)$$
            \subsubsection*{Fourier Inversion Theorem}
                If $f$ and $\tilde{f}$ are integrable, and $f$ is continuous
                $$f(x) = \frac{1}{2\pi} \defint{-\infty}{\infty}{\defint{-\infty}{\infty}{e^{i\omega(x - y)}f(y)}{y}}{\omega}$$
                Using the above property (of $\delta$), it is sufficient to show
                $$\delta(y - x) = \frac{1}{2\pi} \defint{-\infty}{\infty}{e^{i\omega(x - y)}}{\omega}$$
                Letting $z = y - x$, we can just prove the following claim $\forall z \in \mathbb{R}$;
                $$2\pi\delta(z) = \defint{-\infty}{\infty}{e^{-i\omega z}}{\omega}$$
                The proof is not examinable, but is at around Panopto timestamp 46:00.
            \subsubsection*{Common Fourier Transforms}
                \begin{center}
                    \begin{tabular}{|c|c|l|}
                        \hline
                        $f$ & $\tilde{f} = \fourier f$ & comment \\
                        \hline
                    ...
                    \end{tabular}
                \end{center}
        \subsection*{5th March 2020}
            \subsubsection*{Fourier Series}
                Polynomial approximations (such as a Taylor series) is not suitable for a period function $f(x)$, as polynomials themselves aren't periodic.
                Let function $f(x)$ have a period $P$.
                We can then approximate it with a mixture of sinusoids.
                The base frequency is $\omega_0$, defined as;
                $$\omega_0 = \frac{2\pi}{P}$$
                In general, we want to approximate $f(x)$ as a weighted mixture of harmonics, summed over $n$, where $n = 1, 2, \dots$;
                $$\sin \frac{2\pi}{P}nt$$ $$\cos \frac{2\pi}{P}nt$$
                The result $e^{i\theta} = \cos \theta + i\sin \theta$ is also used.
                This can be written in three equivalent forms;
                \begin{align*}
                    f(x) & \approx f^N(x) \\
                    f^N(x) & = \summation{k = -N}{N} a_ke^{i\omega_k x} & \text{or} \\
                    & = \summation{k = -N}{N} c_k\cos \omega_k x + s_k\sin \omega_k x & \text{or} \\
                    & = \summation{k = -N}{N} d_k\cos(\omega_k x + \phi_k) \\
                    \omega_k & = \frac{2\pi k}{P} & a_k, c_k, d_k, s_k, \phi_k \text{ are constants}
                \end{align*}
                Using the common results for Fourier transforms, we can observe that the Fourier transform of $f^N$ is;
                $$\fourier\left(\summation{k = -N}{N} a_ke^{i\omega_k x}\right) = \summation{k = -N}{N}a_k \fourier(e^{i\omega_k x}) = \summation{k = -N}{N}a_k 2 \pi \delta(\omega - \omega_k) = 2 \pi\summation{k = -N}{N}a_k \delta\left(\omega - \frac{2\pi k}{P}\right)$$
                This is known as the spectrum of $f$.
                We mostly assume $x_0 = 0$, without loss of generality.
                \medskip

                Note that $\delta_{k, n}$ is 1 if $k = n$, and 0 otherwise.
                \begin{align*}
                    \defint{0}{P}{e^{i(\omega_k - \omega_n)x}}{x} & = \defint{0}{P}{e^{i\left(\frac{2\pi k}{P} - \frac{2\pi n}{P}\right)x}}{x} & \text{assuming } k \neq n \\
                    & = \defint{0}{P}{e^{\frac{2\pi}{P}(k - n)xi}}{x} \\
                    & = \intbracket{0}{P}{\frac{P}{2\pi(k - n)} e^{\frac{2\pi}{P}(k - n)xi}} \\
                    & = \frac{P}{2\pi(k - n)} \intbracket{0}{P}{e^{\frac{2\pi}{P}(k - n)xi}} \\
                    & = \frac{P}{2\pi(k - n)} (e^{2 \pi i (k - n)} - 1) \\
                    & = \frac{P}{2\pi(k - n)} (1 - 1) \\
                    & = 0 \\
                    \defint{0}{P}{e^{i(\omega_k - \omega_n)x}}{x} & = \defint{0}{P}{1}{x} & \text{assuming } k = n \\
                    & = P \\
                    \defint{0}{P}{e^{i(\omega_k - \omega_n)x}}{x} & = P\delta_{k, n} & \text{generally}
                \end{align*}
                This lemma can now be used to obtain a specific value for $a_n$ as follows;
                \begin{align*}
                    f^N(x) & = \summation{k = -N}{N} a_ke^{i\omega_kx} & \Rightarrow \\
                    f^N(x)e^{-i\omega_nx} & = \summation{k = -N}{N} a_ke^{i\omega_kx}e^{-i\omega_nx} \\
                    & = \summation{k = -N}{N} a_ke^{i(\omega_k - \omega_n)x} & \Rightarrow \\
                    \defint{0}{P}{f^N(x)e^{-i\omega_nx}}{x} & = \summation{k = -N}{N} a_k\defint{0}{P}{e^{i(\omega_k - \omega_n)x}}{x} \\
                    & = \summation{k = -N}{N} a_k P \delta_{k, n} \\
                    & = 0 + \dots + 0 + a_nP + 0 + \dots + 0 \\
                    & = a_nP & \Rightarrow \\
                    a_n & = \frac{1}{P}\defint{0}{P}{f^N(x)e^{-i\omega_nx}}{x} \\
                    & = \frac{1}{P}\defint{0}{P}{f^N(x)e^{-i\omega_nx}}{x} & \text{if $\limit{N}{\infty} f^N(x) = f(x)$}
                \end{align*}
                For an example, let us look at the sawtooth waveform;
                $f(x) = \alpha x$, for $0 \leq x < 1$, and extended periodically throughout the entire real line.
                \begin{align*}
                    f(x) & = \alpha x \\
                    P & = 1 \\
                    a_0 & = \frac{\alpha}{2} \\
                    a_n & = \frac{1}{P}\defint{0}{P}{f(x)e^{-i\omega_nx}}{x} & \text{if it converges to $f$} \\
                    & = \frac{1}{1}\defint{0}{1}{\alpha x e^{-i\frac{2 \pi n}{1}x}}{x} \\
                    & = \alpha \defint{0}{1}{x e^{-2 \pi n i x}}{x} \\
                    & = \alpha \left(\intbracket{0}{1}{-\frac{1}{2 \pi n i} x e^{-2 \pi n i x}} - \defint{0}{1}{-\frac{e^{-2 \pi n i x}}{2 \pi n i}}{x}\right) \\
                    & = -\frac{\alpha}{2 \pi n i} \left(\intbracket{0}{1}{x e^{-2 \pi n i x}} - \underbrace{\defint{0}{1}{e^{-2 \pi n i x}}{x}}_{= 0 \text{ since } n \neq 0}\right) \\
                    & = -\frac{\alpha}{2 \pi n i}
                \end{align*}
                Actually applying this, we get the following results;
                \begin{align*}
                    f^N(x) & = \underbrace{\frac{\alpha}{2}}_{n = 0} - \frac{\alpha}{2 \pi i} \underbrace{\summation{n = 1}{N} \left(\frac{1}{n} e^{i(2 \pi n)x} - \frac{1}{n} e^{-i(2 \pi n)x}\right)}_{n \neq 0} \\
                    & = \frac{\alpha}{2} - \frac{\alpha}{2 \pi i} \summation{n = 1}{N} \frac{2i}{n}\left(\frac{e^{i(2 \pi n)x} - e^{-i(2 \pi n)x}}{2i}\right) \\
                    & = \frac{\alpha}{2} - \frac{\alpha}{2 \pi i} \summation{n = 1}{N} \frac{2i}{n} \sin (2 \pi n x) \\
                    & = \frac{\alpha}{2} - \frac{\alpha}{\pi} \summation{n = 1}{N} \frac{1}{n} \sin (2 \pi n x)
                \end{align*}
            \subsubsection*{Sampling and Discrete Fourier Transform}
                Suppose the discrete function $f(x)$ is sampled at equi-spaced points $\{ 0, T, 2T, \dots, (N - 1)T \}$, where $T$ divides $P$, and $N = \frac{P}{T}$.
                This is equivalent to considering the sampled function $f_s(x)$, defined as;
                \begin{align*}
                    f_s(x) & = \Psi_T(x)f(x) \\
                    \Psi_T(x) & = T \summation{k = -\infty}{\infty} \delta(x - kT)
                \end{align*}
                ...
                \begin{align*}
                    F_k & = \frac{1}{P} \defint{0}{P}{f_s(x)e^{-i\omega_k x}}{x} \\
                    & = \frac{1}{N} \summation{n = 0}{N - 1}f_n e^{-i\omega_k nT} \\
                    \omega_k & = \frac{2 \pi k}{P} \\
                    & = \frac{2 \pi k}{NT} \\
                    f_n & \equiv f(nT)
                \end{align*}
                It has an inverse in the Fourier series of $f(x)$ for $x = nT$;
                $$f_n = \summation{k = 0}{N - 1}  F_k e^{i\omega_k nT}$$
                We often assume $T = 1$, by taking some arbitrary scaling of time.
            \subsubsection*{JPEG and Optics}
                No.
        \subsection*{11th March 2020}
            \subsubsection*{Functions of Several Variables}
                We write functions with $n > 1$ variables as $f(x_1, \dots, x_n)$.
                Let $C^n$ be the set of functions differentiable $n$ times.
                $\nabla$ is the vector differential operator, such that
                $$\nabla f(\vec{x}) = \left(\pdif{f}{x_1}, \dots, \pdif{f}{x_n}\right)$$
                For example, in $n = 2$, let $\vec{h} = \begin{bmatrix}
                    h_1 \\ h_2
                \end{bmatrix}$, then we have
                $$\vec{h} \cdot \nabla f(\vec{x}) = h_1\pdif{f}{x_1} + h_2\pdif{f}{x_2}$$
                This is used in the theorem for the Taylor series in $n$-dimensions.
                It states that if all all the partial derivatives of the function $f(x_1, \dots, x_n)$ exist in a region around $x_1^{(0)}, \dots, x_n^{(0)}$ for small enough $\vec{h}$
                \begin{align*}
                    \vec{h} & = \begin{bmatrix}
                        h_1 \\ \vdots \\ h_n
                    \end{bmatrix} \\
                    f(x_1^{(0)} + h_1, \dots, x_n^{(0)} + h_n) & = f(x_1^{(0)}, \dots, x_n^{(0)}) \\
                    & + \vec{h} \cdot \nabla f(x_1^{(0)}, \dots, x_n^{(0)}) \\
                    & + \frac{1}{2!} (\vec{h} \cdot \nabla)^2 f(x_1^{(0)}, \dots, x_n^{(0)}) \\
                    & \vdots \\
                    & + \frac{1}{n!} (\vec{h} \cdot \nabla)^n f(x_1^{(0)}, \dots, x_n^{(0)}) \\
                    & + \cdots
                \end{align*}
                The proof is as follows;
                \begin{align*}
                    g(t) & = f(\vec{x^{(0)}} + t \vec{h}) \\
                    g(1) & = g(0) + g^\prime(0) + \dots + \frac{1}{n!} g^{(n)}(0) + \dots
                    \intertext{brief example for chain rule, if vector components are functions of $t$}
                    \vec{y} & = \begin{bmatrix}
                        y_1 \\ y_2
                    \end{bmatrix} \\
                    \dif{\vec{y}}{t} \cdot \nabla & = \begin{bmatrix}
                    ...
                    \end{bmatrix} \cdot \begin{bmatrix}
                        \pdif{}{y_1} \\ \pdif{}{y_2}
                    \end{bmatrix} \\
                    & = \dif{y_1}{t}\pdif{}{y_1} + \dif{y_2}{t}\pdif{}{y_2} \\
                    \intertext{using the general case, and continuing}
                    \dif{f(\vec{y})}{t} & = \summation{i = 1}{n} \pdif{f(\vec{y})}{y_i} \dif{y_i}{t} & \text{chain rule, if components are functions of $t$} \\
                    & = \left(\dif{\vec{y}}{t} \cdot \nabla\right)f(\vec{y}) \\
                    \dif{^nf(\vec{y})}{t^n} & = \underbrace{\left(\dif{\vec{y}}{t} \cdot \nabla\right) \cdots \left(\dif{\vec{y}}{t} \cdot \nabla\right)}_{n \text{ times}} f(\vec{y}) \\
                    & = \left(\dif{\vec{y}}{t} \cdot \nabla\right)^n f(\vec{y})
                    \intertext{setting $\vec{y} = \vec{x^{(0)}} + t\vec{h}$}
                    \dif{^ng}{t^n} & = \dif{^nf(\vec{y})}{t^n} \\
                    & = (\vec{h} \cdot \nabla)^n f(\vec{y})
                    \intertext{at $t = 0$, we have $\vec{y} = \vec{x^{(0)}}$}
                    g^{(n)}(0) & = (\vec{h} \cdot \nabla)^n(\vec{x^{(0)}}) \\
                    \text{therefore } g(1) & = \summation{n = 0}{\infty} \frac{(\vec{h} \cdot \nabla)^n(\vec{x^{(0)}})}{n!}
                \end{align*}
            \subsubsection*{Stationary Points}
                Similar to single variable functions, our criteria for a stationary point in $\nabla f(s_1, \dots, s_n) = \vec{0}$, for some stationary point $\vec{s}$.
                Note that the slides (and I assume notes) use $\vec{x_0}$ instead of $\vec{s}$, but I feel it can be confusing.
                This is the same as stating
                $$\pdif{f}{x_1}(s_1, \dots, s_n) = \dots = \pdif{f}{x_n}(s_1, \dots, s_n) = 0$$
                In the case where we have one variable, hence $n = 1$, there are 3 types of stationary point - maximum, minimum, and inflexion.
                However, in the multi-variable case, for $n > 1$, each variable can be in any of the three, therefore there are 9 possible combinations in two dimensions.
                This becomes exponentially more complex in more dimensions, which is why multi-variable optimisation is difficult.
                \medskip

                In order to classify stationary points, we can use the \textbf{Hessian matrix}, defined as such;
                \begin{align*}
                    \partial_i & = \pdif{}{x_i} \\
                    f_{i, j} & = \partial_i \partial_j & f_{i, j} = f_{j, i} \text{ for } f \in C^2 \\
                    & = \pdif{}{x_i} \pdif{}{x_j} f \\
                    \mat{H} & = \begin{bmatrix}
                        f_{1, 1} & f_{1, 2} & \cdots & f_{1, n} \\
                        f_{2, 1} & f_{2, 2} & \cdots & f_{2, n} \\
                        \vdots & \vdots & \ddots & \vdots \\
                        f_{n, 1} & f_{b, 2} & \cdots & f_{n, n}
                    \end{bmatrix}
                \end{align*}
                If $\mat{H}$ is positive definite, meaning it has all positive eigenvalues and a non-zero determinant, it gives a maximum point.
                Similarly, if $\mat{H}$ is negative definite, it gives a maximum.
        \subsection*{12th March 2020}
            \subsubsection*{Quadratic Form}
                The quadratic form is as follows;
                $$f(\vec{x}) = \frac{1}{2}\vec{x}^\top\mat{A}\vec{x} - \vec{b}^\top\vec{x} + c$$
                We can obtain the derivative of this as follows;
                \begin{align*}
                    \pdif{x_i}{x_j} & = \begin{cases}
                        0 & i \neq j \\
                        1 & i = j
                    \end{cases} \\
                    & = \delta_{i, j} \\
                    \summation{n}{i = 1} x_i \delta_{i, j} & = x_j \\
                    \nabla f & = \left(\pdif{f}{x_1}, \dots, \pdif{f}{x_n}\right)
                    \intertext{take arbitrary $j$}
                    \pdif{f}{x_j} & = \pdif{}{x_j} \summation{i, k}{} \frac{1}{2} x_i \mat{A}_{i, k} x_k - \pdif{}{x_j} \summation{i}{} b_i x_i + 0 \\
                    & = \summation{i, k}{} \frac{1}{2} \mat{A}_{i, k} \left(\pdif{x_i}{x_j} x_k + \pdif{x_k}{x_j}x_i\right) - \summation{i}{} \pdif{x_i}{x_j} b_i \\
                    & = \frac{1}{2} \left(\summation{k}{} \mat{A}_{j, k}x_k + \summation{i}{} x_i\mat{A}_{i, j}\right) - b_j \\
                    & = \frac{1}{2} \left(\summation{k}{} \mat{A}_{j, k}x_k + \summation{i}{} \mat{A}^\top_{j, i}x_i\right) - b_j \\
                    & = \frac{1}{2} (\mat{A}\vec{x})_j + (\mat{A}^\top\vec{x})_j - \vec{b}_j & \Rightarrow \\
                    \nabla f & = \frac{1}{2} (\mat{A} + \mat{A}^\top)\vec{x} - \vec{b}
                \end{align*}
                If $\mat{A}$ is symmetric, you have $\mat{A} = \mat{A}^\top$, so $\nabla f = \mat{A}\vec{x} - \vec{b}$.
                If it is also positive definite, then the solution to $\mat{A}\vec{x} = \vec{b}$ globally minimises $f(\vec{x})$.
                Similarly, if $f(\vec{x})$ is minimised by $\vec{x} = \vec{y}$, then $\vec{y}$ is the solution to $\mat{A}\vec{x} = \vec{b}$, therefore there exists a duality between these two.
            \subsubsection*{Iterative Solutions for Function Minimisation}
                We start by picking some initial vector $\vec{x_0}$ as a guess.
                At each step $k = 1, 2, \dots$, we choose a direction vector $\vec{d_k}$ and a step size $\alpha_k$.
                The iteration is
                \begin{center}
                    $\vec{x_{k + 1}} - \vec{x_k} + \alpha_k\vec{d_k}$
                \end{center}
                Some steepest descent method (SDM) is as follows;
                \medskip

                This method chooses the direction in which $f(\vec{x_k})$ decreases the fastest, hence we choose $\vec{d_k} = -\nabla f(\vec{x_k})$.
                When $\mat{A}$ is symmetric, $\vec{d_k} = \vec{b} - \mat{A}\vec{x_k}$, in the quadratic form example, we have $\vec{d_k}$ as the residual vector.
                \medskip

                To choose the step length, we want to minimise $f(\vec{x_k} + \alpha_k \vec{d_k})$;
                \begin{align*}
                    \text{let } \vec{x} & = \vec{x_k} \\
                    \dif{f}{\alpha_k} & = \summation{i}{} \pdif{f(\vec{x})}{x_i} \dif{x_i}{\alpha} \\
                    & = \summation{i}{} \left(\nabla f(\vec{x_{k + 1}})\right)_i (\vec{d_k})_i \\
                    & = \nabla f(\vec{x_{k + 1}}) \cdot \vec{d_k} \\
                    & = \vec{d_{k + 1}} \cdot \vec{d_k}
                \end{align*}
                To minimise this, set it to zero, therefore we want to choose $\alpha$ such that $\vec{d_{k + 1}}$ is orthogonal to $\vec{d_k}$.
                Therefore in general we want to solve $(\nabla f(\vec{x_k})) \cdot (\nabla f(\vec{x_{k + 1}})) = 0$
                \medskip

                An example is as follows (quadratic form);
                \begin{align*}
                    \vec{r_k}^\top(\vec{b} - \mat{A}(\vec{x_k} + \alpha_k\vec{r_k})) & = \vec{r_k}^\top(\vec{r_k} - \alpha_k\mat{A}\vec{r_k}) \\
                    & = 0 & \text{(solve)} \\
                    \alpha_k & = \frac{\vec{r_k}^\top\vec{r_k}}{\vec{r_k}^\top\mat{A}\vec{r_k}} \\
                    & = \frac{\Vert \vec{r_k} \Vert^2}{\vec{r_k}^\top\mat{A}\vec{r_k}}
                \end{align*}
                By the following iteration, we approximate a solution for $\vec{x}$;
                \begin{align*}
                    \vec{x_k} & = \mat{A}\vec{r_k} \\
                    \alpha_k & = \frac{\Vert \vec{r_k} \Vert^2}{\vec{r_k}^\top\vec{v_k}} \\
                    \vec{x_{k + 1}} & = \vec{x_k} + \alpha_k\vec{r_k} \\
                    \vec{r_{k + 1}} & = \vec{r_k} - \alpha_k\vec{v_k}
                \end{align*}
                This takes a single matrix-vector multiplication per iteration, and one more in the initialisation.
            \subsubsection*{Example of Iterative Method}
                Suppose we want to minimise the function $f(x, y) = x^2 + y^2$.
                By inspection, we know the minimum, for real $x, y$, is $(0, 0)$.
                However, numerically, we do the following;
                \begin{align*}
                    \text{guess } \vec{x_0} & = (x_0, y_0) & \text{minimum} \\
                    \vec{d_0} & = -\nabla f(x_0, y_0) \\
                    & = \left. -(2x, 2y) \right|_{\vec{x} = \vec{x_0}} \\
                    & = -2(x_0, y_0) \\
                    & = -2\vec{x_0} \\
                    x_1 & = x_0 + \alpha (-2 x_0) \\
                    & = (1 - 2\alpha)x_0 \\
                    ...
                    \vec{d_1} & = -2(x_1, y_1) \\
                    & = -2\vec{x_1} \\
                    \text{solve } \vec{d_0} \cdot \vec{d_1} & = 0 & \Leftrightarrow \\
                    x_0x_1 + y_0y_1 & = 0 & \Leftrightarrow \\
                    (1 - 2\alpha)x_0^2 + (1 - 2\alpha)y_0^2 & = 0 & \Leftrightarrow \\
                    (1 - 2\alpha)(x_0^2 + y_0^2) & = 0 & \Rightarrow \\
                    \alpha & = \frac{1}{2}
                    \intertext{after this computation, we have the next step, so;}
                    \vec{d_0} & = -2(x_0, y_0) \\
                    & = -2\vec{x_0} \\
                    \vec{x_1} & = \vec{x_0} + \alpha\vec{d_0} \\
                    & = \vec{x_0} + \frac{1}{2} (-2\vec{x_0}) \\
                    & = \vec{0} \\
                    & = (0, 0)
                \end{align*}
