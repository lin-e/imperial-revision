    ...
    \section*{CO142 - Discrete Structures}
        ...
        \subsection*{16th November 2018}
            \subsubsection*{Something on the Union of Countable Sets}
                ...
                \end{enumerate}
            \subsubsection*{???}
                I'm pretty sure there was something important here that I need to rewatch, about diagonalisation.
            ...
            \subsubsection*{Orderings}
                ...
                \begin{itemize}
                    ...
                    \item lexigraphical order \hfill $\la a_1, b_1 \ra \leq_P \la a_2, b_2 \ra \triangleq a_1 \leq_A a_2 \lor (a_1 =_A a_2 \land b_1 \leq_B b_2)$
                \end{itemize}
                If both $(A, \leq_A)$, and $(B, \leq_B)$ are total orders, the lexigraphical order is also a total order, but in general the product order is partial.
        ...
        \subsection*{20th November 2018}
            \subsubsection*{Questions on the Divisor Order}
                ...
                Finally, we want to prove that it's reflexive. Take an arbitary $n \in \mathbb{N}^+$. Trivially, we can say $n = 1 \cdot n$, and as $1 \in \mathbb{Z}$, we have $n \leq_D n$, hence $\leq_D$ is also reflexive. However, as we've proven the other proerties, it follows that it is a partial order.
                \medskip
