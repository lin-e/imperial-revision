            ...
            \subsubsection*{Structs, and Alignment}
                ...
                \begin{center}
                    \begin{tabular}{c|l|l|l}
                        size (bytes) & examples & lowest address bits (Linux) & lowest address bits (Windows) \\
                        \hline
                        1 & ~char~ & no restriction & no restriction \\
                        2 & ~short~ & ~0~$_2$ & ~0~$_2$ \\
                        4 & ~int, float, char*~ & ~00~$_2$ & ~00~$_2$ \\
                        8 & ~double~ & ~00~$_2$ & ~000~$_2$ \\
                        12 & ~long double~ & ~00~$_2$ & ~00~$_2$
                    \end{tabular}
                \end{center}
