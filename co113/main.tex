...
\begin{document}
    \section*{CO113 - Architecture}
        ...
        \subsection*{Lecture 9}
            Note that pipelining is not examined. In order to handle unexpected events, the processor has to implement addtional circuitry. There are two types of unexpected events that can occur;
            \begin{itemize}
                \itemsep0em
                \item 
            \end{itemize}
