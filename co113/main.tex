    ...
    \section*{CO113 - Architecture}
        ...
        \subsection*{Caches}
            ...
            \subsubsection*{Cache Organisation}
                ...
                On the other hand, we need to consider what happens when we have a miss on a write. We can either do \textbf{write-allocate}, which loads the address into cache, and updates the line, which is beneficial if there will be more writes to the location, or to do \textbf{no-write-allocate}, which directly writes to memory instead. The typical cache is \textbf{write-back}, and \textbf{write-allocate}, although some machines are occasionally \textbf{write-through}, and \textbf{no-write-allocate}.
